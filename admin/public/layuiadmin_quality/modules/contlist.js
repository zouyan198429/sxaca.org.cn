...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field: 'id', width: 100, title: '仪器ID', sort: true}
      ,{field: 'label', title: '仪器名称', minWidth: 100}
      ,{field: 'title', title: '附件数量'}
      ,{field: 'author', title: '使用部门'}
      ,{field: 'author', title: '使用人'}
  ...
  table.on('tool(LAY-app-content-list)', function(obj){
    var data = obj.data;
    if(obj.event === 'del'){
      layer.confirm('确定删除此仪器？', function(index){
        obj.del();
        layer.close(index);
      });
