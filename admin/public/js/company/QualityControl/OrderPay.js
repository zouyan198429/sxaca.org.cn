...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.pay_order_no%><hr/><%=item.pay_no%><\/td>");
    ...
    document.write("            <td><%=item.pay_type_text%><hr/><%=item.pay_status_text%><\/td>");
    document.write("            <td>￥<%=item.pay_price%><hr/><%=item.frozen_status_text%><\/td>");
    document.write("            <td><%=item.parent_pay_no%><\/td>");
    document.write("            <td><%=item.order_time%><hr/><%=item.sure_time%><\/td>");
    // document.write("            <td>");
