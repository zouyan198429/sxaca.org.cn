...
(function() {
   ...
   document.write("            <td><%=item.ability_info.created_at%><\/td>");
    ...
    document.write("            <td><%=item.join_item_reslut_info.submit_status_text%><hr/><%=item.submit_off_time%><\/td>");
    ...
    document.write("                    <i class=\"ace-icon fa fa-cloud-upload bigger-60\"> 数据上报<\/i>");
    document.write("                <\/a>");
    document.write("                <%}%>");
    document.write("                <%if( item.status == 2 && item.is_sample == 8 && item.submit_status == 4){%>");
    document.write("                <a href=\"javascript:void(0);\" class=\"btn btn-mini btn-success\"  onclick=\"otheraction.sampleResult(<%=item.id%>,'<%=item.ability_name%>')\">");
    document.write("                    <i class=\"ace-icon fa fa-cloud-upload bigger-60\"> 补测数据上报<\/i>");
    document.write("                <\/a>");
    document.write("                <%}%>");
    document.write("                <%if( item.retry_no > 0 || (item.retry_no == 0 && item.submit_status == 2)){%>");
    ...
    document.write("                <\/a>");
    document.write("                <%}%>");
    document.write("                <%if( item.retry_no > 1 || (item.retry_no == 1 && item.submit_status == 8)){%>");
