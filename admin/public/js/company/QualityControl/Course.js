...
var otheraction = {
    join:function (id, course_name) {
        ...
        var weburl = JOIN_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    // document.write("                <\/a>");
    document.write("                <a href=\"javascript:void(0);\" class=\"btn btn-mini btn-info\" onclick=\"otheraction.join(<%=item.id%>, '<%=item.course_name%>')\">");
    document.write("                    <i class=\"ace-icon fa fa-pencil bigger-60\"> 报名<\/i>");
    document.write("                <\/a>");
