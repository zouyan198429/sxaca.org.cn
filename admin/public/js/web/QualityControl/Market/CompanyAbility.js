...
console.log('==full');
operateLayuiIframeSize(PARENT_LAYER_INDEX, 2);// 最小化弹窗
...
$(function(){
    setTimeout(function () {
        console.log('==restore');
        operateLayuiIframeSize(PARENT_LAYER_INDEX, 8);// 还原 后触发的回调
    },500);
...
(function() {
    ...
    document.write("       <%");
    document.write("        var show_time = true;");
    document.write("        var old_test_year = '';");
    document.write("        var old_test_code = '';");
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    //document.write("        }");
    document.write("        show_time = false;");
    document.write("        if( item.test_year != old_test_year || item.test_code != old_test_code){");
    document.write("            old_test_year = item.test_year;");
    document.write("            old_test_code = item.test_code;");
    document.write("            show_time = true;");
    document.write("        }");
    document.write("        ");
    document.write("        %>");
    document.write("");
    ...
    document.write("            <%if( show_time){%>");
    document.write("            <td rowspan=\"<%=item.child_num%>\"><%=item.test_year%><\/td>");
    document.write("            <td rowspan=\"<%=item.child_num%>\"><%=item.test_code%><\/td>");
    document.write("            <%}%>");

    document.write("            <td><%=item.test_item%><\/td>");
    document.write("            <td><%=item.test_result%><\/td>");
