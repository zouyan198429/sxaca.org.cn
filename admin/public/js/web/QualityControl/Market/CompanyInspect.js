...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.year_no%><\/td>");
    document.write("            <td><%=item.exist_problem%><\/td>");
    document.write("            <td><%=item.breach_clause%><\/td>");
    document.write("            <td><a href=\"<%=item.link_url%>\" target='_blank'><%=item.link_url%></a><\/td>");
