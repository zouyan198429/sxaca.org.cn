...
//     }
    openVideoList:function(void_id, vod_name){
        var href = VIDEO_LIST_URL + '?hidden_option=2&vod_id=' + void_id;
        layuiGoIframe(href, vod_name + '--课程管理');
    },
    openVideoOrder:function(void_id, vod_name){
        var href = VIDEO_ORDERS_URL + '?hidden_option=2&vod_id=' + void_id;
        layuiGoIframe(href, vod_name + '--购买记录管理');
    },
...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.vod_name%><hr/><%=item.type_name%><\/td>");
    document.write("            <td>");
    ...
    document.write("            <td><%=item.effectively_day_text%><\/td>");
    ...
    document.write("            <td><%=item.open_status_text%><hr/><%=item.recommend_status_text%><\/td>");
    ...
    document.write("                <\/a>");
    document.write("                <%}%>");
    document.write("                <a href=\"javascript:void(0);\" class=\"btn btn-mini btn-info\" onclick=\"otheraction.openVideoList(<%=item.id%>,'<%=item.vod_name%>')\">");
    document.write("                    <i class=\"ace-icon fa fa-file-video-o bigger-60\"> 课件<\/i>");
    document.write("                <\/a>");
    ...
    document.write("                <\/a>");
    document.write("                <%}%>");
    document.write("                <a href=\"javascript:void(0);\" class=\"btn btn-mini btn-info\" onclick=\"otheraction.openVideoOrder(<%=item.id%>,'<%=item.vod_name%>')\">");
    document.write("                    <i class=\"ace-icon fa fa-file-video-o bigger-60\"> 购买记录(<%=item.sale_num%>)<\/i>");
    document.write("                <\/a>");
    document.write("                <%if( false){%>");
