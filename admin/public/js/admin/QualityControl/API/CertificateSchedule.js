...
var otheraction = {
    ...
    upExcelFileAPI : function(id){// 接口能力范围测试【批量】
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_BATH_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_BATH_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_BATH_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
    ...
    upAddFilesAPI : function(id){// 接口企业文件测试【批量】
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_FILES_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_FILES_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_FILES_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
    ...
    upBathModifyAPI : function(id){// 接口能力范围删除或新加测试【批量】
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_BATH_MODIFY_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_BATH_MODIFY_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_BATH_MODIFY_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
    ...
    upCompanyModifyAPI : function(id){// 接口能力范围测试【批量】
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_COMPANY_MODIFY_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_COMPANY_MODIFY_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_COMPANY_MODIFY_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
    ...
    updateAPI : function(id){// 接口能力范围测试【批量】
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_UPDATE_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_UPDATE_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_UPDATE_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
    ...
    upGetListAPI : function(id){// 接口获得记录列表
        //获得表单各name的值
        var data = get_frm_values(SURE_FRM_IDS);// {} parent.get_frm_values(SURE_FRM_IDS)
        console.log(IFRAME_GET_LIST_API_URL);
        console.log(data);
        var url_params = get_url_param(data);// parent.get_url_param(data)
        var weburl = IFRAME_GET_LIST_API_URL + id + '?' + url_params;
        console.log(weburl);
        // go(SHOW_URL + id);
        // location.href='/pms/Supplier/show?supplier_id='+id;
        // var weburl = SHOW_URL + id;
        // var weburl = '/pms/Supplier/show?supplier_id='+id+"&operate_type=1";
        var tishi = IFRAME_GET_LIST_API_URL_TITLE;//"添加/修改供应商";
        var operateText = "添加";
        if(id > 0){
            operateText = "修改";
        }
