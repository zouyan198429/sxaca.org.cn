...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.pay_company_name%><hr/><%=item.xsf_mc%><\/td>");
    document.write("            <td><%=item.xsf_dz%><hr/><%=item.xsf_dh%><\/td>");
    document.write("            <td><%=item.xsf_nsrsbh%><\/td>");
    document.write("            <td><%=item.xsf_yh%><hr/><%=item.xsf_yhzh%><\/td>");
