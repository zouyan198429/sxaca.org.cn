...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.module_name%><hr/><%=item.open_status_text%><\/td>");
    document.write("            <td><%=item.template_name%><hr/><%=item.template_key%><\/td>");
    document.write("            <td><%=item.template_type_text%><\/td>");
    ...
    document.write("                 %>");
    document.write("                <%if( (key & item.limit_code) == key){%>");
    document.write("                 <p><%=key%><%=limitText%><\/p>");
    document.write("                <%}%>");
    document.write("            <%}%>");
    document.write("           <\/td>");
    document.write("                <%}%>");
