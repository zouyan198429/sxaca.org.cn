...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.template_type_text%><hr/><%=item.send_type_text%><\/td>");
    document.write("            <td><%=item.country_code%><hr/><%=item.sms_status_text%><\/td>");
    document.write("            <td><%=item.mobile%><\/td>");
    document.write("            <td><%=item.sms_content%><\/td>");
    document.write("            <td><%=item.fail_reason%><\/td>");
