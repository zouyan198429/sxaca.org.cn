...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.template_name%><hr/><%=item.xmmc%><\/td>");
    document.write("            <td><%=item.spbm%><hr/><%=item.zxbm%><\/td>");
    document.write("            <td><%=item.yhzcbs_text%><hr/><%=item.sl%><\/td>");
    document.write("            <td><%=item.lslbs_text%><hr/><%=item.zzstsgl%><\/td>");
    document.write("            <td><%=item.ggxh%><hr/><%=item.dw%><\/td>");
    document.write("            <td><%=item.append_name_text%><hr/><%=item.merge_goods_text%><\/td>");
