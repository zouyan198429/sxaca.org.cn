...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.group_name%><hr/><%=item.group_no%><\/td>");
    document.write("            <td><%=item.real_name%><hr/><%=item.sex_name%><\/td>");
    document.write("            <td><%=item.id_number%><hr/><%=item.birth_date%><\/td>");
    document.write("            <td><%=item.relation_name%><hr/><%=item.politics_name%><\/td>");
    document.write("            <td><%=item.addr%><hr/><%=item.contact%><\/td>");
