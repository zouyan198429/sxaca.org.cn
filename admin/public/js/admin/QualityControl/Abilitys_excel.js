...
function ajax_form(){
    ...
    // if(!judge_validate(4,'检验检测机构代码',test_code,true,'length',1,30)){
    //     return false;
    // }

    var test_year = $('input[name=test_year]').val();
    if(!judge_validate(4,'年',test_year,true,'digit','','')){
        return false;
    }

    // var test_item = $('input[name=test_item]').val();
    // if(!judge_validate(4,'检测项目',test_item,true,'length',1,50)){
    //     return false;
    // }
    //
    // var test_result = $('input[name=test_result]').val();
    // if(!judge_validate(4,'验证结果',test_result,true,'length',1,30)){
    //     return false;
    // }
    //
    // var remarks = $('textarea[name=remarks]').val();
    // if(!judge_validate(4,'备注',remarks,false,'length',1,500)){
    //     return false;
    // }
