...
(function() {
    ...
    document.write("        var module_params = item.module_params;");
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.module_name%><\/td>");
    document.write("            <td><%=item.open_status_text%><\/td>");
    document.write("            <td><%=item.remarks%><\/td>");
    document.write("           <td>");
    document.write("            <%for(var j = 0; j<module_params.length;j++){");
    document.write("                var jitem = module_params[j];");
    document.write("                 %>");
    ...
    // document.write("              </a>");
    document.write("                <%=jitem.param_name%>【<%=jitem.param_code%>】【<%=jitem.param_type_text%>】【<%=jitem.date_time_format%>】【<%=jitem.fixed_val%>】<br/>");
    document.write("            <%}%>");
    document.write("           <\/td>");
