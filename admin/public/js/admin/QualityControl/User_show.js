...
(function() {
    ...
    document.write("            <td><%=item.real_name%>(<%=item.sex_text%>)<hr/><%=item.city_name%><\/td>");
    // document.write("            <td><%=item.sex_text%><\/td>");
    document.write("            <td><%=item.mobile%><hr/><%=item.is_perfect_text%><\/td>");
    ...
    document.write("            <td>");
    document.write("            <%=item.position_name%><hr/><%=item.role_num_text%>");
    document.write("            <\/td>");
    document.write("            <td>");
