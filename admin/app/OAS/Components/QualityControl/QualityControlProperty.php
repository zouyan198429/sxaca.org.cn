...
namespace App\OAS\Components\QualityControl;
 ...
 *  公共属性(具体库)-数量
 * @ OA\Schema(
 *   schema="common_Schema_QualityControl_aaaaa",
 *   type="integer",
 *   format="int64",
 *   title="公共属性(具体库)-数量",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_pay_type",
 *   type="integer",
 *   format="int32",
 *   title="公共属性(具体库)-支付方式",
 ...
 * 公共属性(具体库)-支付方式文字
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_pay_type_text",
 *   type="string",
 ...
 *  公共属性(具体库)-拥有者类型
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_ower_type",
 *   type="integer",
 *   format="int64",
 ...
 * 公共属性(具体库)-拥有者类型文字
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_ower_type_text",
 *   type="string",
 ...
 *  公共属性(具体库)-拥有者id
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_ower_id",
 *   type="integer",
 *   format="int64",
 ...
 *  公共属性(具体库)-拥有者历史id
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_ower_id_history",
 *   type="integer",
 *   format="int64",
 ...
 *  公共属性(具体库)-派送用户id
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_send_staff_id",
 *   type="integer",
 *   format="int64",
 ...
 *  公共属性(具体库)-派送用户历史id
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_send_staff_id_history",
 *   type="integer",
 *   format="int64",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_revoked",
 *   type="integer",
 *   format="int32",
 *   title="公共属性(具体库)-作废状态",
 ...
 * 公共属性(具体库)-作废状态
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_revoked_text",
 *   type="string",
 *   title="公共属性(具体库)-作废状态",
 ...
 * 公共属性(具体库)-名称
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_name",
 *   type="string",
 *   title="公共属性(具体库)-名称",
 ...
 * 公共属性(具体库)-到期时间
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_expires_at",
 *   type="string",
 *   format="date-time",
 *   title="公共属性(具体库)-到期时间",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_create_num",
 *   type="string",
 *   title="公共属性(具体库)-下单序号",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_pay_num",
 *   type="string",
 *   title="公共属性(具体库)-付款序号",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_sure_num",
 *   type="string",
 *   title="公共属性(具体库)-确认序号",
 ...
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_business_type",
 *   type="integer",
 *   format="int32",
 *   title="公共属性(具体库)-业务类型",
 ...
 * 公共属性(具体库)-支付方式文字
 * @OA\Schema(
 *   schema="common_Schema_QualityControl_business_type_text",
 *   type="string",
 *   title="公共属性(具体库)-支付方式文字",
 *   description="公共属性(具体库)-支付方式文字",
 *   default="",
