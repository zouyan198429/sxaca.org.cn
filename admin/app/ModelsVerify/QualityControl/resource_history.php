...
class resource_history extends BaseDBVerify
{
    public static $model_name = 'QualityControl\ResourceHistory';// 相对于Models的数据模型名称;在子类中定义，使用时用static::,不用self::
    public static $table_name = 'resource_history';// 数据表名称
    // 需要从父的去掉的字段  -- 一维数组
    ...
    public static function getTableConfig($dbFileTag = 'models', $langModel = [], $langModelDB = [], $langTable = []){
        // $tableConfig = ['aaaa'];
        // 如果用父类的，则在此指定父类
         $tableConfig = resource::getVerifyRuleArr($dbFileTag);
        return $tableConfig;
    }
     ...
     * 资源历史属性-品牌名称
     * @ OA\Schema(
     *   schema="Schema_QualityControl_resource_history_brand_name",
     *   type="string",
     *   title="资源历史属性-品牌名称",
     *   description="资源历史属性-品牌名称",
     *   default="",
     *   minLength=0,
     *   maxLength=30,
     *   example="川渝人家",
     ...
     * 资源历史属性-id
     * @OA\Schema(
     *   schema="Schema_QualityControl_resource_history_id",
     *   type="integer",
     *   format="int32",
     *   title="资源历史属性-id",
     *   description="资源历史属性-id",
     *   default=0,
     *   minimum="0",
     *   example="1",
     * )
     ...
     * 模糊查询字段名--具体的表模型用
     * @OA\Parameter(
     *      parameter="Parameter_QualityControl_resource_history_field",
     *      name="field",
     *      in="query",
     *      description="模糊查询字段名",
     *      required=false,
    ...
    /**
     * @OA\Schema(
     *     schema="Schema_QualityControl_resource_history_obj",
     *     title="资源历史",
     *     description="资源历史列表",
     *     required={},
     ...
     *
     * @OA\RequestBody(
     *     request="RequestBody_QualityControl_info_resource_history",
     *     description="单个增加",
     *     required=true,
     *     @OA\JsonContent(ref="#/components/schemas/Schema_QualityControl_resource_history_obj"),
     *     @OA\MediaType(
     *         mediaType="application/xml",
     *         @OA\Schema(
     *              @OA\Property(property="info", ref="#/components/schemas/Schema_QualityControl_resource_history_obj"),
     *              @OA\Xml(
     *                  name="root",
     *                  wrapped=true
     *              ),
     ...
     *
     * @OA\RequestBody(
     *     request="RequestBody_QualityControl_multi_resource_history",
     *     description="批量增加",
     *     required=true,
     *     @OA\JsonContent(
     *          type="object",
     ...
     *              property="data_list",
     *              type="array",
     *              @OA\Items(ref="#/components/schemas/Schema_QualityControl_resource_history_obj"),
     *          ),
     *     ),
     *     @OA\MediaType(
     *         mediaType="application/xml",
     ...
     * 列表页
     *     @OA\Response(
     *         response="Response_QualityControl_list_resource_history",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     ...
     * }
     *     @OA\Response(
     *         response="Response_QualityControl_info_resource_history",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     *              @OA\Property(property="apistatus", ref="#/components/schemas/common_Schema_apistatus"),
     ...
     * }
     *     @OA\Response(
     *         response="Response_QualityControl_result_resource_history",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     *              @OA\Property(property="apistatus", ref="#/components/schemas/common_Schema_apistatus"),
     *              @OA\Property(property="result",ref="#/components/schemas/Schema_QualityControl_resource_history_obj"),
     *              @OA\Property(property="errorMsg", ref="#/components/schemas/common_Schema_errorMsg"),
     *        ),
     *        @OA\XmlContent(
     *              type="object",
