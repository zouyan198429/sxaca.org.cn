...
class OrderPayController extends BasicController
{
...
//            return view('company.QualityControl.OrderPay.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'company.QualityControl.OrderPay.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIOrderPayBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIOrderPayBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('company.QualityControl.OrderPay.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('company.QualityControl.OrderPay.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'company.QualityControl.OrderPay.add', true
...
//    }
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'company.QualityControl.OrderPay.info', false
    ...
    /**
     * @OA\Get(
     *     path="/api/company/order_pay/ajax_info",
     *     tags={"企业后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="companyQualityControlOrderPayAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_order_pay"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_order_pay"}
     */
    /**
     * ajax获得详情数据
     *
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/company/order_pay/ajax_save",
     *     tags={"企业后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="companyQualityControlOrderPayAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_required"),
...
//                ];
//                 // 价格转为整型
//                Tool::bathPriceCutFloatInt($saveData, OrderPay::$IntPriceFields, OrderPay::$IntPriceIndex, 1);
//
////        if($id <= 0) {// 新加;要加入的特别字段
////            $addNewData = [
...
//                ];
//                $resultDatas = CTAPIOrderPayBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
//                return ajaxDataArr(1, $resultDatas, '');
//        });
//    }
...
//                ];
    ...
    /**
     * @OA\Get(
     *     path="/api/company/order_pay/ajax_alist",
     *     tags={"企业后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--列表",
     *     description="第三方对帐单--列表......",
     *     operationId="companyQualityControlOrderPayAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_order_pay"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        return  CTAPIOrderPayBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            CTAPIOrderPayBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                // 'handleKeyArr' => $handleKeyArr,//一维数组，数数据需要处理的标记，每一个或类处理，根据情况 自定义标记，然后再处理函数中处理数据。
                'relationFormatConfigs'=> CTAPIOrderPayBusiness::getRelationConfigs($request, $this,
                    [
...
//        $this->InitParams($request);
//        $result = CTAPIOrderPayBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIOrderPayBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/company/order_pay/ajax_del",
     *     tags={"企业后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="companyQualityControlOrderPayAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_required"),
...
//    {
////        $this->InitParams($request);
////        return CTAPIOrderPayBusiness::delAjax($request, $this);
//
...
//            $id = CommonRequest::getInt($request, 'id');
//            $info = CTAPIOrderPayBusiness::getInfoDataBase($request, $this, '', $id, [], '', 1);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIOrderPayBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIOrderPayBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIOrderPayBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
