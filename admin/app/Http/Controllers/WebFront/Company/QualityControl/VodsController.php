...
//            return view('company.QualityControl.Vods.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'company.QualityControl.Vods.index', true
...
//            return view('company.QualityControl.Vods.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('company.QualityControl.Vods.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'company.QualityControl.Vods.add', true
...
//    }
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'company.QualityControl.Vods.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/company/vods/ajax_info",
     *     tags={"企业后台-视频点播-点播课程"},
     *     summary="点播课程--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="companyQualityControlVodsAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/company/vods/ajax_save",
     *     tags={"企业后台-视频点播-点播课程"},
     *     summary="点播课程--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="companyQualityControlVodsAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_id_required"),
...
//        $this->InitParams($request);
    ...
    /**
     * @OA\Get(
     *     path="/api/company/vods/ajax_alist",
     *     tags={"企业后台-视频点播-点播课程"},
     *     summary="点播课程--列表",
     *     description="点播课程--列表......",
     *     operationId="companyQualityControlVodsAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//                    ]
    ...
    {
        return $this->exeDoPublicFun($request, 34359738368, 8, 'company.QualityControl.SmsTemplate.sms_send', true
            , '', [], function (&$reDataArr) use ($request){
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/company/vods/ajax_del",
     *     tags={"企业后台-视频点播-点播课程"},
     *     summary="点播课程--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="companyQualityControlVodsAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_id_required"),
