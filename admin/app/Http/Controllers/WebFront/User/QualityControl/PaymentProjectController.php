...
//            return view('user.QualityControl.PaymentProject.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'user.QualityControl.PaymentProject.index', true
...
//            return view('user.QualityControl.PaymentProject.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('user.QualityControl.PaymentProject.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'user.QualityControl.PaymentProject.add', true
    ...
    {
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'user.QualityControl.PaymentProject.add_pay', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'user.QualityControl.PaymentProject.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_project/ajax_info",
     *     tags={"用户中心-付款/收款相关的-付款/收款项目"},
     *     summary="付款/收款项目--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="userQualityControlPaymentProjectAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_project/ajax_save",
     *     tags={"用户中心-付款/收款相关的-付款/收款项目"},
     *     summary="付款/收款项目--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="userQualityControlPaymentProjectAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_project_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $pay_company_id = $this->organize_id;// CommonRequest::getInt($request, 'pay_company_id');
                $pay_user_id = $this->personal_id;// CommonRequest::getInt($request, 'pay_user_id');
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_project/ajax_alist",
     *     tags={"用户中心-付款/收款相关的-付款/收款项目"},
     *     summary="付款/收款项目--列表",
     *     description="付款/收款项目--列表......",
     *     operationId="userQualityControlPaymentProjectAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//            ];
//            CTAPIPaymentProjectBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_project/ajax_del",
     *     tags={"用户中心-付款/收款相关的-付款/收款项目"},
     *     summary="付款/收款项目--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="userQualityControlPaymentProjectAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_project_id_required"),
