...
use App\Business\Controller\API\QualityControl\CTAPIPaymentRecordLogBusiness;
...
class PaymentRecordLogController extends BasicController
{
...
//            return view('user.QualityControl.PaymentRecordLog.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'user.QualityControl.PaymentRecordLog.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIPaymentRecordLogBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIPaymentRecordLogBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('user.QualityControl.PaymentRecordLog.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('user.QualityControl.PaymentRecordLog.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'user.QualityControl.PaymentRecordLog.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'user.QualityControl.PaymentRecordLog.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_record_log/ajax_info",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="userQualityControlPaymentRecordLogAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_payment_record_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_payment_record_log"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIPaymentRecordLogBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_record_log/ajax_save",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="userQualityControlPaymentRecordLogAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_required"),
...
//                ];
//                $resultDatas = CTAPIPaymentRecordLogBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
//                return ajaxDataArr(1, $resultDatas, '');
//        });
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_record_log/ajax_alist",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--列表",
     *     description="付款/收款记录操作日志--列表......",
     *     operationId="userQualityControlPaymentRecordLogAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_payment_record_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIPaymentRecordLogBusiness::getList($request, $this, 2 + 4);
...
//            CTAPIAbbbBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPIPaymentRecordLogBusiness::getRelationConfigs($request, $this,
                    [
                        'company_info' => '',
            ...
            return  CTAPIPaymentRecordLogBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPIPaymentRecordLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIPaymentRecordLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIPaymentRecordLogBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_record_log/ajax_del",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="userQualityControlPaymentRecordLogAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_required"),
...
//    {
////        $this->InitParams($request);
////        return CTAPIPaymentRecordLogBusiness::delAjax($request, $this);
//
...
//            return CTAPIPaymentRecordLogBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
//        });
//    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIPaymentRecordLogBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIPaymentRecordLogBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIPaymentRecordLogBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPIPaymentRecordLogBusiness::getInfoData($request, $this, $id, [], '', $extParams);
