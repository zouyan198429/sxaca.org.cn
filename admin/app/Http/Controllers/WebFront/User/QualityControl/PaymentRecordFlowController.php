...
use App\Business\Controller\API\QualityControl\CTAPIPaymentRecordFlowBusiness;
...
class PaymentRecordFlowController extends BasicController
{
...
//            return view('user.QualityControl.PaymentRecordFlow.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'user.QualityControl.PaymentRecordFlow.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIPaymentRecordFlowBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIPaymentRecordFlowBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('user.QualityControl.PaymentRecordFlow.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
//        return $this->exeDoPublicFun($request, 2048, 1, 'user.QualityControl.RrrDddd.select', true
//            , 'doListPage', [], function (&$reDataArr) use ($request){
//
//            });
//    }
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('user.QualityControl.PaymentRecordFlow.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'user.QualityControl.PaymentRecordFlow.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'user.QualityControl.PaymentRecordFlow.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_record_flow/ajax_info",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录流水"},
     *     summary="付款/收款记录流水--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="userQualityControlPaymentRecordFlowAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_flow_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_payment_record_flow"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_payment_record_flow"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIPaymentRecordFlowBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_record_flow/ajax_save",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录流水"},
     *     summary="付款/收款记录流水--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="userQualityControlPaymentRecordFlowAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_flow_id_required"),
...
//                ];
//                $resultDatas = CTAPIPaymentRecordFlowBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
//                return ajaxDataArr(1, $resultDatas, '');
//        });
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/user/payment_record_flow/ajax_alist",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录流水"},
     *     summary="付款/收款记录流水--列表",
     *     description="付款/收款记录流水--列表......",
     *     operationId="userQualityControlPaymentRecordFlowAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_flow_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_payment_record_flow"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIPaymentRecordFlowBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){

            // 根据条件获得项目列表数据
            $mergeParams = [
                // 'company_id' => $this->user_id,
                'pay_user_id' => $this->personal_id,
            ];
            CTAPIPaymentRecordFlowBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                // 'handleKeyArr' => $handleKeyArr,//一维数组，数数据需要处理的标记，每一个或类处理，根据情况 自定义标记，然后再处理函数中处理数据。
                'relationFormatConfigs'=> CTAPIPaymentRecordFlowBusiness::getRelationConfigs($request, $this,
                    [
                        'company_info' => '',
            ...
            return  CTAPIPaymentRecordFlowBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
    ...
    {
        return $this->exeDoPublicFun($request, 34359738368, 8, 'user.QualityControl.SmsTemplate.sms_send', true
            , '', [], function (&$reDataArr) use ($request){
...
//        $this->InitParams($request);
//        $result = CTAPIPaymentRecordFlowBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIPaymentRecordFlowBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIPaymentRecordFlowBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/user/payment_record_flow/ajax_del",
     *     tags={"用户中心-付款/收款相关的-付款/收款记录流水"},
     *     summary="付款/收款记录流水--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="userQualityControlPaymentRecordFlowAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_flow_id_required"),
...
//    {
////        $this->InitParams($request);
////        return CTAPIPaymentRecordFlowBusiness::delAjax($request, $this);
//
...
//            return CTAPIPaymentRecordFlowBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
//        });
//    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIPaymentRecordFlowBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIPaymentRecordFlowBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIPaymentRecordFlowBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        // 支付类型1付款2退款
        $reDataArr['payType'] =  PaymentRecordFlow::PAY_TYPE_ARR;
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPIPaymentRecordFlowBusiness::getInfoData($request, $this, $id, [], '', $extParams);
