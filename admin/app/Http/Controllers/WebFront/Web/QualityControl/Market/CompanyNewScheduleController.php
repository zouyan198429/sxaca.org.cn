...
class CompanyNewScheduleController extends BasicController
{
    ...
    {
        return $this->exeDoPublicFun($request, 1, 1, 'web.QualityControl.Market.CompanyNewSchedule.index', false
...
//    {
//        return $this->exeDoPublicFun($request, 0, 8, 'web.QualityControl.Market.CompanyNewSchedule.show', false
...
//    {
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'web.QualityControl.Market.CompanyNewSchedule.add', false
    ...
    public function ajax_alist(Request $request){
        return $this->exeDoPublicFun($request, 4, 4,'', false, '', [], function (&$reDataArr) use ($request){
            ...
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPICompanyScheduleBusiness::getRelationConfigs($request, $this,
                    ['company_info' => '', 'resource_list' => '', 'resource_pdf_list' => ''], []),
            ];
