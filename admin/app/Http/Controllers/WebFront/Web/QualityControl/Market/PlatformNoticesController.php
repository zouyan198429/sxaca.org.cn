...
class PlatformNoticesController extends BasicController
{
    ...
    {
        return $this->exeDoPublicFun($request, 1, 1, 'web.QualityControl.Market.PlatformNotices.index', false
    ...
    {
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'web.QualityControl.Market.PlatformNotices.add', false
...
//        return  CTAPIPlatformNoticesBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', false, '', [], function (&$reDataArr) use ($request){
            ...
            $result = CTAPIPlatformNoticesBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
