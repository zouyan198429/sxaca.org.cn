...
class PlatformDownFilesController extends BasicController
{
    ...
    {
        return $this->exeDoPublicFun($request, 1, 1, 'web.QualityControl.Market.PlatformDownFiles.index', false
    ...
    {
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'web.QualityControl.Market.PlatformDownFiles.add', false
...
//        return  CTAPIPlatformDownFilesBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', false, '', [], function (&$reDataArr) use ($request){
            ...
            $result =  CTAPIPlatformDownFilesBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
