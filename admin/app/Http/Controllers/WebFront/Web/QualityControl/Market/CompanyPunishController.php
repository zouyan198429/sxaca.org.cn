...
class CompanyPunishController extends BasicController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->exeDoPublicFun($request, 1, 1, 'web.QualityControl.Market.CompanyPunish.index', false
...
//    {
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'web.QualityControl.Market.CompanyPunish.add', false
...
//        return  CTAPICompanyPunishBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', false, '', [], function (&$reDataArr) use ($request){
            ...
            $result = CTAPICompanyPunishBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
