...
//                'company_peoples_num' => 0,// 单位人数1、1-20、2、20-100、3、100-500、4、500以上
    ...
    {
        return $this->exeDoPublicFun($request, 1, 1, 'expert.QualityControl.' . static::$VIEW_NAME . '.grade_area', true
            , '', [], function (&$reDataArr) use ($request){
    ...
    {
        return $this->exeDoPublicFun($request, 1, 1, 'expert.QualityControl.' . static::$VIEW_NAME . '.grade_industry', true
            , '', [], function (&$reDataArr) use ($request){
