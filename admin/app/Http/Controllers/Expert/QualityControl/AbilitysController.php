...
//
//            return view('expert.QualityControl.Abilitys.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'expert.QualityControl.Abilitys.index', true
    ...
    {
        return $this->exeDoPublicFun($request, 2048, 1, 'expert.QualityControl.Abilitys.select', true
            , 'doListPage', [], function (&$reDataArr) use ($request){
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('expert.QualityControl.Abilitys.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'expert.QualityControl.Abilitys.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 0, 8,'expert.QualityControl.Abilitys.publish', true
    ...
    public function info(Request $request,$id = 0)
    {
        ...
        return Tool::doViewPages($this, $request, function (&$reDataArr) use($request, &$id){
            ...
            return view('expert.QualityControl.Abilitys.info', $reDataArr);
...
//            });
    ...
    /**
     * @OA\Get(
     *     path="/api/expert/abilitys/ajax_info",
     *     tags={"大后台-能力验证-能力验证"},
     *     summary="能力验证--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="expertQualityControlAbilitysAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/expert/abilitys/ajax_save",
     *     tags={"大后台-能力验证-能力验证"},
     *     summary="能力验证--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="expertQualityControlAbilitysAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_abilitys_id_required"),
...
//        $this->InitParams($request);
    ...
    /**
     * @OA\Get(
     *     path="/api/expert/abilitys/ajax_alist",
     *     tags={"大后台-能力验证-能力验证"},
     *     summary="能力验证--列表",
     *     description="能力验证--列表......",
     *     operationId="expertQualityControlAbilitysAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/expert/abilitys/ajax_del",
     *     tags={"大后台-能力验证-能力验证"},
     *     summary="能力验证--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="expertQualityControlAbilitysAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_abilitys_id_required"),
