...
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'expert.QualityControl.AbilitysAdmin.index', true
     ...
     * @author zouyan(305463219@qq.com)
     */
    public function basic(Request $request, $ability_id = 0)
    {
...
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'expert.QualityControl.AbilitysAdmin.basic', true
