...
//            return view('admin.QualityControl.CompanyInspect.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyInspect.index', true
...
//            return view('admin.QualityControl.CompanyInspect.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanyInspect.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyInspect.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanyInspect.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_inspect/ajax_info",
     *     tags={"大后台-检验机构信息管理-监督检查"},
     *     summary="监督检查--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyInspectAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_inspect/ajax_save",
     *     tags={"大后台-检验机构信息管理-监督检查"},
     *     summary="监督检查--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyInspectAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_inspect_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $year_no = CommonRequest::getInt($request, 'year_no');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_inspect/ajax_alist",
     *     tags={"大后台-检验机构信息管理-监督检查"},
     *     summary="监督检查--列表",
     *     description="监督检查--列表......",
     *     operationId="adminQualityControlCompanyInspectAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//        return  CTAPICompanyInspectBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return  CTAPICompanyInspectBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_inspect/ajax_del",
     *     tags={"大后台-检验机构信息管理-监督检查"},
     *     summary="监督检查--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyInspectAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_inspect_id_required"),
