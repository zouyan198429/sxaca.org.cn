...
//            return view('admin.QualityControl.CompanyAbility.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyAbility.index', true
...
//            return view('admin.QualityControl.CompanyAbility.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanyAbility.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyAbility.add', true
    ...
    {
        $pageNum = 0;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyAbility.add_excel', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanyAbility.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_ability/ajax_info",
     *     tags={"大后台-检验机构信息管理-能力验证"},
     *     summary="能力验证--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyAbilityAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_ability/ajax_save",
     *     tags={"大后台-检验机构信息管理-能力验证"},
     *     summary="能力验证--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyAbilityAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_ability_id_required"),
...
//        $resource_id = [];
                ...
                CTAPICompanyAbilityBusiness::mergeRequest($request, $this, $mergeParams);
                ...
                try{
                    ...
                    if ($resourceId > 0) {
                        CTAPICompanyAbilityBusiness::mergeRequest($request, $this, [
                            'id' => $resourceId,
                        ]);
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_ability/ajax_alist",
     *     tags={"大后台-检验机构信息管理-能力验证"},
     *     summary="能力验证--列表",
     *     description="能力验证--列表......",
     *     operationId="adminQualityControlCompanyAbilityAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//        return  CTAPICompanyAbilityBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return  CTAPICompanyAbilityBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        CTAPICompanyAbilityBusiness::importTemplate($request, $this);
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_ability/ajax_del",
     *     tags={"大后台-检验机构信息管理-能力验证"},
     *     summary="能力验证--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyAbilityAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_ability_id_required"),
