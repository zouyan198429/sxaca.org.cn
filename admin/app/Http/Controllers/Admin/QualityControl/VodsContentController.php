...
use App\Business\Controller\API\QualityControl\CTAPIVodsContentBusiness;
...
class VodsContentController extends BasicController
{
...
//            return view('admin.QualityControl.VodsContent.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.VodsContent.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIVodsContentBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIVodsContentBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.VodsContent.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.VodsContent.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.VodsContent.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.VodsContent.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vods_content/ajax_info",
     *     tags={"大后台-视频点播-点播课程内容"},
     *     summary="点播课程内容--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlVodsContentAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_content_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_vods_content"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_vods_content"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIVodsContentBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vods_content/ajax_save",
     *     tags={"大后台-视频点播-点播课程内容"},
     *     summary="点播课程内容--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlVodsContentAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_content_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $vods_content_name = CommonRequest::get($request, 'vods_content_name');
                $simple_name = CommonRequest::get($request, 'simple_name');
                $sort_num = CommonRequest::getInt($request, 'sort_num');

                $saveData = [
                    'vods_content_name' => $vods_content_name,
...
//        }
                ...
                $resultDatas = CTAPIVodsContentBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vods_content/ajax_alist",
     *     tags={"大后台-视频点播-点播课程内容"},
     *     summary="点播课程内容--列表",
     *     description="点播课程内容--列表......",
     *     operationId="adminQualityControlVodsContentAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_content_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_vods_content"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIVodsContentBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPIVodsContentBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodsContentBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodsContentBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vods_content/ajax_del",
     *     tags={"大后台-视频点播-点播课程内容"},
     *     summary="点播课程内容--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlVodsContentAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vods_content_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIVodsContentBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIVodsContentBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIVodsContentBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIVodsContentBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
