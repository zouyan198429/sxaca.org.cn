...
//            return view('admin.QualityControl.CompanySchedule.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanySchedule.index', true
    ...
    public function show(Request $request,$company_id = 0)
    {
        ...
        return Tool::doViewPages($this, $request, function (&$reDataArr) use($request, &$company_id){
            ...
            return view('admin.QualityControl.CompanySchedule.show', $reDataArr);
...
//            return view('admin.QualityControl.CompanySchedule.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanySchedule.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanySchedule.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/quality_control/company_schedule/ajax_info",
     *     tags={"大后台-能力验证-能力附表"},
     *     summary="能力附表--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyScheduleAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/quality_control/company_schedule/ajax_save",
     *     tags={"大后台-能力验证-能力附表"},
     *     summary="能力附表--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyScheduleAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_schedule_id_required"),
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/quality_control/company_schedule/ajax_alist",
     *     tags={"大后台-能力验证-能力附表"},
     *     summary="能力附表--列表",
     *     description="能力附表--列表......",
     *     operationId="adminQualityControlCompanyScheduleAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/quality_control/company_schedule/ajax_del",
     *     tags={"大后台-能力验证-能力附表"},
     *     summary="能力附表--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyScheduleAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_schedule_id_required"),
