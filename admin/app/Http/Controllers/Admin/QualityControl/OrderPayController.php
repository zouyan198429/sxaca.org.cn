...
//            return view('admin.QualityControl.OrderPay.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.OrderPay.index', true
...
//            return view('admin.QualityControl.OrderPay.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_pay/ajax_info",
     *     tags={"大后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlOrderPayAjax_info",
     *     deprecated=false,
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_pay/ajax_save",
     *     tags={"大后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlOrderPayAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_required"),
...
//                ];
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_pay/ajax_alist",
     *     tags={"大后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--列表",
     *     description="第三方对帐单--列表......",
     *     operationId="adminQualityControlOrderPayAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_pay/ajax_del",
     *     tags={"大后台-订单管理-第三方对帐单"},
     *     summary="第三方对帐单--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlOrderPayAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_id_required"),
