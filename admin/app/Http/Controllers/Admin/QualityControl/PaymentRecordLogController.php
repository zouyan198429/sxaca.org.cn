...
//            return view('admin.QualityControl.PaymentRecordLog.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.PaymentRecordLog.index', true
...
//            return view('admin.QualityControl.PaymentRecordLog.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.PaymentRecordLog.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.PaymentRecordLog.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.PaymentRecordLog.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/payment_record_log/ajax_info",
     *     tags={"大后台-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlPaymentRecordLogAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/payment_record_log/ajax_save",
     *     tags={"大后台-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlPaymentRecordLogAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_required"),
...
//                    if($company_id != $info['company_id']) throws('您没有此记录的操作权限');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/payment_record_log/ajax_alist",
     *     tags={"大后台-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--列表",
     *     description="付款/收款记录操作日志--列表......",
     *     operationId="adminQualityControlPaymentRecordLogAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/payment_record_log/ajax_del",
     *     tags={"大后台-付款/收款相关的-付款/收款记录操作日志"},
     *     summary="付款/收款记录操作日志--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlPaymentRecordLogAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_payment_record_log_id_required"),
