...
use App\Business\Controller\API\QualityControl\CTAPIAbilityCodeBusiness;
...
class AbilityCodeController extends BasicController
{
...
//            return view('admin.QualityControl.AbilityCode.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.AbilityCode.index', true
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            $reDataArr['province_kv'] = CTAPIAbilityCodeBusiness::getCityByPid($request, $this,  0);
////            $reDataArr['province_kv'] = CTAPIAbilityCodeBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
////            $reDataArr['province_id'] = 0;
////            return view('admin.QualityControl.AbilityCode.select', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//        return $this->exeDoPublicFun($request, 2048, 1, 'admin.QualityControl.AbilityCode.select', true
//            , 'doListPage', [], function (&$reDataArr) use ($request){
//
//            });
//    }
...
//            if ($id > 0) { // 获得详情数据
//                $operate = "修改";
//                $info = CTAPIAbilityCodeBusiness::getInfoData($request, $this, $id, [], '', []);
//            }
//            // $reDataArr = array_merge($reDataArr, $resultDatas);
//            $reDataArr['info'] = $info;
//            $reDataArr['operate'] = $operate;
//            return view('admin.QualityControl.AbilityCode.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.AbilityCode.add', true
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $sign_date = CommonRequest::get($request, 'sign_date');
...
//        }
                ...
                $resultDatas = CTAPIAbilityCodeBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
            });
    }
...
//        $this->InitParams($request);
//        return  CTAPIAbilityCodeBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPIAbilityCodeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIAbilityCodeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIAbilityCodeBusiness::importTemplate($request, $this);
...
//    {
////        $this->InitParams($request);
////        return CTAPIAbilityCodeBusiness::delAjax($request, $this);
//
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIAbilityCodeBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIAbilityCodeBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIAbilityCodeBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
