...
use App\Business\Controller\API\QualityControl\CTAPIVodSalesBusiness;
...
class VodSalesController extends BasicController
{
...
//            return view('admin.QualityControl.VodSales.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.VodSales.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIVodSalesBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIVodSalesBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.VodSales.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.VodSales.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.VodSales.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.VodSales.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_sales/ajax_info",
     *     tags={"大后台-视频点播-点播课程销量统计"},
     *     summary="点播课程销量统计--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlVodSalesAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_sales_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_vod_sales"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_vod_sales"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIVodSalesBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_sales/ajax_save",
     *     tags={"大后台-视频点播-点播课程销量统计"},
     *     summary="点播课程销量统计--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlVodSalesAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_sales_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $vod_sales_name = CommonRequest::get($request, 'vod_sales_name');
                $simple_name = CommonRequest::get($request, 'simple_name');
                $sort_num = CommonRequest::getInt($request, 'sort_num');

                $saveData = [
                    'vod_sales_name' => $vod_sales_name,
...
//        }
                ...
                $resultDatas = CTAPIVodSalesBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_sales/ajax_alist",
     *     tags={"大后台-视频点播-点播课程销量统计"},
     *     summary="点播课程销量统计--列表",
     *     description="点播课程销量统计--列表......",
     *     operationId="adminQualityControlVodSalesAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_sales_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_vod_sales"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIVodSalesBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPIVodSalesBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodSalesBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodSalesBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_sales/ajax_del",
     *     tags={"大后台-视频点播-点播课程销量统计"},
     *     summary="点播课程销量统计--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlVodSalesAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_sales_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIVodSalesBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIVodSalesBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIVodSalesBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIVodSalesBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
