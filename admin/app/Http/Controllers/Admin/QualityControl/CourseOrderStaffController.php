...
//        CTAPICourseOrderStaffBusiness::getList($request, $this, 1 + 0);
        return $this->exeDoPublicFun($request, 4096, 8,'', true, '', [], function (&$reDataArr) use ($request){
            $mergeParams = [
                'is_export' => 2,
                'sms_template_id' => 1,
                'input_param_code' => 'test_input',
                'input_param_val' => '质量认证协会',// '123',//
                'mobile_field' => 'mobile',
                'ids' => '84',
            ];
...
//            return view('admin.QualityControl.CourseOrderStaff.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseOrderStaff.index', true
...
//            return view('admin.QualityControl.CourseOrderStaff.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//                $class_id = CommonRequest::getInt($request, 'class_id');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_order_staff/ajax_info",
     *     tags={"大后台-面授培训-报名学员"},
     *     summary="报名学员--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCourseOrderStaffAjax_info",
     *     deprecated=false,
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_order_staff/ajax_save",
     *     tags={"大后台-面授培训-报名学员"},
     *     summary="报名学员--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCourseOrderStaffAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_order_staff_id_required"),
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_order_staff/ajax_alist",
     *     tags={"大后台-面授培训-报名学员"},
     *     summary="报名学员--列表",
     *     description="报名学员--列表......",
     *     operationId="adminQualityControlCourseOrderStaffAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//        return  CTAPICourseOrderStaffBusiness::getList($request, $this, 2 + 4);
    ...
    public function ajax_sms_send(Request $request){
        return $this->exeDoPublicFun($request, 68719476736, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPICourseOrderStaffBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
        });
    }
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_order_staff/ajax_del",
     *     tags={"大后台-面授培训-报名学员"},
     *     summary="报名学员--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCourseOrderStaffAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_order_staff_id_required"),
