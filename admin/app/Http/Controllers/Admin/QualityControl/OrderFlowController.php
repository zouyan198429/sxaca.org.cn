...
//            return view('admin.QualityControl.OrderFlow.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.OrderFlow.index', true
...
//            return view('admin.QualityControl.OrderFlow.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('admin.QualityControl.OrderFlow.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.OrderFlow.add', true
...
//    }
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.OrderFlow.info', false
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_flow/ajax_info",
     *     tags={"大后台-订单管理-财务流水"},
     *     summary="财务流水--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlOrderFlowAjax_info",
     *     deprecated=false,
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_flow/ajax_save",
     *     tags={"大后台-订单管理-财务流水"},
     *     summary="财务流水--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlOrderFlowAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_flow_id_required"),
...
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_flow/ajax_alist",
     *     tags={"大后台-订单管理-财务流水"},
     *     summary="财务流水--列表",
     *     description="财务流水--列表......",
     *     operationId="adminQualityControlOrderFlowAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_flow/ajax_del",
     *     tags={"大后台-订单管理-财务流水"},
     *     summary="财务流水--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlOrderFlowAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_flow_id_required"),
