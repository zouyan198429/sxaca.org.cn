...
//            return view('admin.QualityControl.CompanyStatement.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyStatement.index', true
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            $reDataArr['province_kv'] = CTAPICompanyStatementBusiness::getCityByPid($request, $this,  0);
////            $reDataArr['province_kv'] = CTAPICompanyStatementBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
////            $reDataArr['province_id'] = 0;
////            return view('admin.QualityControl.CompanyStatement.select', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//        return $this->exeDoPublicFun($request, 2048, 1, 'admin.QualityControl.CompanyStatement.select', true
//            , 'doListPage', [], function (&$reDataArr) use ($request){
//
//            });
//    }
...
//            if ($id > 0) { // 获得详情数据
//                $operate = "修改";
//                $info = CTAPICompanyStatementBusiness::getInfoData($request, $this, $id, [], '', []);
//            }
//            // $reDataArr = array_merge($reDataArr, $resultDatas);
//            $reDataArr['info'] = $info;
//            $reDataArr['operate'] = $operate;
//            return view('admin.QualityControl.CompanyStatement.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyStatement.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_statement/ajax_info",
     *     tags={"大后台-检验机构信息管理平台-机构自我声明"},
     *     summary="机构自我声明--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyStatementAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_statement_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_statement"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_statement"}
     */
    /**
     * ajax获得详情数据
     *
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_statement/ajax_save",
     *     tags={"大后台-检验机构信息管理平台-机构自我声明"},
     *     summary="机构自我声明--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyStatementAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_statement_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $resultDatas = CTAPICompanyStatementBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
            });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_statement/ajax_alist",
     *     tags={"大后台-检验机构信息管理平台-机构自我声明"},
     *     summary="机构自我声明--列表",
     *     description="机构自我声明--列表......",
     *     operationId="adminQualityControlCompanyStatementAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_statement_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_statement"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        $result = CTAPICompanyStatementBusiness::getList($request, $this, 1 + 0);
...
////        $this->InitParams($request);
////        CTAPICompanyStatementBusiness::getList($request, $this, 1 + 0);
...
//                'relationFormatConfigs'=> CTAPICompanyStatementBusiness::getRelationConfigs($request, $this, $handleKeyConfigArr, []),
//            ];
//            CTAPICompanyStatementBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
//        });
//    }
...
////        $this->InitParams($request);
////        CTAPICompanyStatementBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_statement/ajax_del",
     *     tags={"大后台-检验机构信息管理平台-机构自我声明"},
     *     summary="机构自我声明--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyStatementAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_statement_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanyStatementBusiness::delAjax($request, $this);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPICompanyStatementBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
//            return CTAPICompanyStatementBusiness::delAjax($request, $this);
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanyStatementBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanyStatementBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanyStatementBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
