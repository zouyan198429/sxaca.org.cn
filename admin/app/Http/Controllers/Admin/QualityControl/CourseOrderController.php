...
//            return view('admin.QualityControl.CourseOrder.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseOrder.index', true
...
//            return view('admin.QualityControl.CourseOrder.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('admin.QualityControl.CourseOrder.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CourseOrder.add', true
...
//    }
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CourseOrder.info', false
...
//                $class_id = CommonRequest::getInt($request, 'class_id');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_order/ajax_info",
     *     tags={"大后台-面授培训-报名企业"},
     *     summary="报名企业--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCourseOrderAjax_info",
     *     deprecated=false,
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_order/ajax_save",
     *     tags={"大后台-面授培训-报名企业"},
     *     summary="报名企业--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCourseOrderAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_order_id_required"),
...
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_order/ajax_alist",
     *     tags={"大后台-面授培训-报名企业"},
     *     summary="报名企业--列表",
     *     description="报名企业--列表......",
     *     operationId="adminQualityControlCourseOrderAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_order/ajax_del",
     *     tags={"大后台-面授培训-报名企业"},
     *     summary="报名企业--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCourseOrderAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_order_id_required"),
