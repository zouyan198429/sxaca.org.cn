...
//            return view('admin.QualityControl.Course.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.Course.index', true
...
//            return view('admin.QualityControl.Course.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.Course.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.Course.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course/ajax_info",
     *     tags={"大后台-面授培训-课程管理"},
     *     summary="课程管理--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCourseAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course/ajax_save",
     *     tags={"大后台-面授培训-课程管理"},
     *     summary="课程管理--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCourseAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_id_required"),
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course/ajax_alist",
     *     tags={"大后台-面授培训-课程管理"},
     *     summary="课程管理--列表",
     *     description="课程管理--列表......",
     *     operationId="adminQualityControlCourseAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course/ajax_del",
     *     tags={"大后台-面授培训-课程管理"},
     *     summary="课程管理--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCourseAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_id_required"),
