...
use App\Models\QualityControl\ApiLog;
use App\Services\Request\CommonRequest;
use App\Services\Tool;
use Illuminate\Http\Request;

class ApiLogController extends BasicController
{
...
//            return view('admin.QualityControl.ApiLog.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.ApiLog.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIApiLogBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIApiLogBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.ApiLog.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.ApiLog.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.ApiLog.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/api_log/ajax_info",
     *     tags={"大后台-API接口-api接口日志"},
     *     summary="api接口日志--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlApiLogAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_api_log_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_api_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_api_log"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIApiLogBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/api_log/ajax_save",
     *     tags={"大后台-API接口-api接口日志"},
     *     summary="api接口日志--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlApiLogAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_api_log_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $api_log_name = CommonRequest::get($request, 'api_log_name');
...
//        }
                ...
                $resultDatas = CTAPIApiLogBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/api_log/ajax_alist",
     *     tags={"大后台-API接口-api接口日志"},
     *     summary="api接口日志--列表",
     *     description="api接口日志--列表......",
     *     operationId="adminQualityControlApiLogAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_api_log_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_api_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIApiLogBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPIApiLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIApiLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIApiLogBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/api_log/ajax_del",
     *     tags={"大后台-API接口-api接口日志"},
     *     summary="api接口日志--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlApiLogAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_api_log_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIApiLogBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIApiLogBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIApiLogBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIApiLogBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        // 状态1执行中 2成功4失败
        $reDataArr['doStatus'] =  ApiLog::$doStatusArr;
        $reDataArr['defaultDoStatus'] =  -1;// 列表页默认状态

        // 执行响应等级(1超光速-半秒; 2 光速-1秒；4极速-2秒；8普速-4秒；16慢速-6秒；32 超慢速-8秒；64 龟速；128等定 )
        $reDataArr['responseLevel'] =  ApiLog::$responseLevelArr;
        $reDataArr['defaultResponseLevel'] = -1;// 列表页默认状态
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        // 状态1执行中 2成功4失败
        $reDataArr['doStatus'] =  ApiLog::$doStatusArr;
        $reDataArr['defaultDoStatus'] = $info['do_status'] ?? -1;// 列表页默认状态

        // 执行响应等级(1超光速-半秒; 2 光速-1秒；4极速-2秒；8普速-4秒；16慢速-6秒；32 超慢速-8秒；64 龟速；128等定 )
        $reDataArr['responseLevel'] =  ApiLog::$responseLevelArr;
        $reDataArr['defaultResponseLevel'] = $info['response_level'] ?? -1;// 列表页默认状态
