...
use App\Business\Controller\API\QualityControl\CTAPILaboratoryAddrBusiness;
use App\Business\Controller\API\QualityControl\CTAPISmsTemplateBusiness;
use App\Business\Controller\API\QualityControl\CTAPIStaffBusiness;
use App\Http\Controllers\WorksController;
use App\Models\QualityControl\LaboratoryAddr;
use App\Services\Request\CommonRequest;
use App\Services\Tool;
use Illuminate\Http\Request;

class LaboratoryAddrController extends BasicController
{
...
//            return view('admin.QualityControl.LaboratoryAddr.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.LaboratoryAddr.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPILaboratoryAddrBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPILaboratoryAddrBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.LaboratoryAddr.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.LaboratoryAddr.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.LaboratoryAddr.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/laboratory_addr/ajax_info",
     *     tags={"大后台-企业管理-实验室地址"},
     *     summary="实验室地址--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlLaboratoryAddrAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_laboratory_addr_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_laboratory_addr"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_laboratory_addr"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPILaboratoryAddrBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/laboratory_addr/ajax_save",
     *     tags={"大后台-企业管理-实验室地址"},
     *     summary="实验室地址--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlLaboratoryAddrAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_laboratory_addr_id_required"),
...
//                    $saveData = array_merge($saveData, $addNewData);
                ...
                $resultDatas = CTAPILaboratoryAddrBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/laboratory_addr/ajax_alist",
     *     tags={"大后台-企业管理-实验室地址"},
     *     summary="实验室地址--列表",
     *     description="实验室地址--列表......",
     *     operationId="adminQualityControlLaboratoryAddrAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_laboratory_addr_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_laboratory_addr"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPILaboratoryAddrBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){

            $handleKeyConfigArr = ['company_info' => ''];
            $extParams = [
                // 'handleKeyArr' => $handleKeyArr,//一维数组，数数据需要处理的标记，每一个或类处理，根据情况 自定义标记，然后再处理函数中处理数据。
                'relationFormatConfigs'=> CTAPILaboratoryAddrBusiness::getRelationConfigs($request, $this, $handleKeyConfigArr, []),
            ];
            return  CTAPILaboratoryAddrBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPILaboratoryAddrBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPILaboratoryAddrBusiness::getList($request, $this, 1 + 0);
...
//            'relationFormatConfigs'=> CTAPILaboratoryAddrBusiness::getRelationConfigs($request, $this, $handleKeyConfigArr, []),
//        ];
//            CTAPILaboratoryAddrBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
//        });
//    }
...
//        $this->InitParams($request);
//        CTAPILaboratoryAddrBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/laboratory_addr/ajax_del",
     *     tags={"大后台-企业管理-实验室地址"},
     *     summary="实验室地址--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlLaboratoryAddrAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_laboratory_addr_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPILaboratoryAddrBusiness::delAjax($request, $this);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPILaboratoryAddrBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
            // return CTAPILaboratoryAddrBusiness::delAjax($request, $this);
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPILaboratoryAddrBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPILaboratoryAddrBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPILaboratoryAddrBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//    }
    ...
    public function doListPage(Request $request, &$reDataArr, $extendParams = []){
        ...
        // 开启状态(1开启2关闭)
        $reDataArr['openStatus'] =  LaboratoryAddr::$openStatusArr;
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPILaboratoryAddrBusiness::getInfoData($request, $this, $id, [], '', $extParams);
        }
