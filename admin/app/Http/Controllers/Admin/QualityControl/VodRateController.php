...
use App\Business\Controller\API\QualityControl\CTAPIVodRateBusiness;
...
class VodRateController extends BasicController
{
...
//            return view('admin.QualityControl.VodRate.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.VodRate.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIVodRateBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIVodRateBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.VodRate.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.VodRate.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.VodRate.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.VodRate.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_rate/ajax_info",
     *     tags={"大后台-视频点播-学员学习进度"},
     *     summary="学员学习进度--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlVodRateAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_rate_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_vod_rate"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_vod_rate"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIVodRateBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_rate/ajax_save",
     *     tags={"大后台-视频点播-学员学习进度"},
     *     summary="学员学习进度--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlVodRateAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_rate_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $vod_rate_name = CommonRequest::get($request, 'vod_rate_name');
                $simple_name = CommonRequest::get($request, 'simple_name');
                $sort_num = CommonRequest::getInt($request, 'sort_num');

                $saveData = [
                    'vod_rate_name' => $vod_rate_name,
...
//        }
                ...
                $resultDatas = CTAPIVodRateBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_rate/ajax_alist",
     *     tags={"大后台-视频点播-学员学习进度"},
     *     summary="学员学习进度--列表",
     *     description="学员学习进度--列表......",
     *     operationId="adminQualityControlVodRateAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_rate_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_vod_rate"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIVodRateBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPIVodRateBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodRateBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIVodRateBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_rate/ajax_del",
     *     tags={"大后台-视频点播-学员学习进度"},
     *     summary="学员学习进度--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlVodRateAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_rate_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIVodRateBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIVodRateBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIVodRateBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIVodRateBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
