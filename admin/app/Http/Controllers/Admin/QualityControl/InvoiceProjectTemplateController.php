...
class InvoiceProjectTemplateController extends BasicController
{
...
//            return view('admin.QualityControl.InvoiceProjectTemplate.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.InvoiceProjectTemplate.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIInvoiceProjectTemplateBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIInvoiceProjectTemplateBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.InvoiceProjectTemplate.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.InvoiceProjectTemplate.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.InvoiceProjectTemplate.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/invoice_project_template/ajax_info",
     *     tags={"大后台-电子发票管理-发票商品项目模板"},
     *     summary="发票商品项目模板--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlInvoiceProjectTemplateAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_project_template_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_invoice_project_template"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_invoice_project_template"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPIInvoiceProjectTemplateBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoice_project_template/ajax_save",
     *     tags={"大后台-电子发票管理-发票商品项目模板"},
     *     summary="发票商品项目模板--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlInvoiceProjectTemplateAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_project_template_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $xmmc = CommonRequest::get($request, 'xmmc');
                $spbm = CommonRequest::get($request, 'spbm');
                $zxbm = CommonRequest::get($request, 'zxbm');
                $ggxh = CommonRequest::get($request, 'ggxh');
                $dw = CommonRequest::get($request, 'dw');
                $sl = CommonRequest::get($request, 'sl');
                $yhzcbs = CommonRequest::getInt($request, 'yhzcbs');
                $lslbs = CommonRequest::get($request, 'lslbs');
                $zzstsgl = CommonRequest::get($request, 'zzstsgl');
                $append_name = CommonRequest::getInt($request, 'append_name');
                $merge_goods = CommonRequest::getInt($request, 'merge_goods');
...
//        }
                ...
                $resultDatas = CTAPIInvoiceProjectTemplateBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/invoice_project_template/ajax_alist",
     *     tags={"大后台-电子发票管理-发票商品项目模板"},
     *     summary="发票商品项目模板--列表",
     *     description="发票商品项目模板--列表......",
     *     operationId="adminQualityControlInvoiceProjectTemplateAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_project_template_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_invoice_project_template"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIInvoiceProjectTemplateBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){

            $extParams = [
                // 'handleKeyArr' => $handleKeyArr,//一维数组，数数据需要处理的标记，每一个或类处理，根据情况 自定义标记，然后再处理函数中处理数据。
                'relationFormatConfigs'=> CTAPIInvoiceProjectTemplateBusiness::getRelationConfigs($request, $this,
                    [
                        // 'pay_company_name' => '',
                    ], []),
                 'listHandleKeyArr' => ['priceIntToFloat'],
            ];
            return  CTAPIInvoiceProjectTemplateBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPIInvoiceProjectTemplateBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIInvoiceProjectTemplateBusiness::getList($request, $this, 1 + 0);
...
//                'listHandleKeyArr' => ['priceIntToFloat'],
//            ];
//            CTAPIInvoiceProjectTemplateBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
//        });
//    }
...
//        $this->InitParams($request);
//        CTAPIInvoiceProjectTemplateBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoice_project_template/ajax_del",
     *     tags={"大后台-电子发票管理-发票商品项目模板"},
     *     summary="发票商品项目模板--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlInvoiceProjectTemplateAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_project_template_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIInvoiceProjectTemplateBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIInvoiceProjectTemplateBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIInvoiceProjectTemplateBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIInvoiceProjectTemplateBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        // 开启状态(1开启2关闭)
        $reDataArr['openStatus'] =  InvoiceProjectTemplate::$openStatusArr;
        $reDataArr['defaultOpenStatus'] = -1;// 列表页默认状态

        // 优惠政策标识 0：不使用，1：使用
        $reDataArr['yhzcbs'] =  InvoiceProjectTemplate::$yhzcbsArr;
        $reDataArr['defaultYhzcbs'] = -1;// 列表页默认状态

        // 零税率标识 空：非零税率， 1：免税，2：不征收，3普通零税率
        $reDataArr['lslbs'] =  InvoiceProjectTemplate::$lslbsArr;
        $reDataArr['defaultLslbs'] = -1;// 列表页默认状态

        // 名称后是否还要加具体商品名称1不补加商品名称2补加商品名称
        $reDataArr['appendName'] =  InvoiceProjectTemplate::$appendNameArr;
        $reDataArr['defaultAppendName'] = -1;// 列表页默认状态

        // 是否合并开票1分开开票--不合并2合并开票
        $reDataArr['mergeGoods'] =  InvoiceProjectTemplate::$mergeGoodsArr;
        $reDataArr['defaultMergeGoods'] = -1;// 列表页默认状态
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPIInvoiceProjectTemplateBusiness::getInfoData($request, $this, $id, [], '', $extParams);
        }
        ...
        // 优惠政策标识 0：不使用，1：使用
        $reDataArr['yhzcbs'] =  InvoiceProjectTemplate::$yhzcbsArr;
        $reDataArr['defaultYhzcbs'] = $info['yhzcbs'] ?? -1;// 列表页默认状态

        // 零税率标识 空：非零税率， 1：免税，2：不征收，3普通零税率
        $reDataArr['lslbs'] =  InvoiceProjectTemplate::$lslbsArr;
        $reDataArr['defaultLslbs'] = $info['lslbs'] ?? -1;// 列表页默认状态

        // 名称后是否还要加具体商品名称1不补加商品名称2补加商品名称
        $reDataArr['appendName'] =  InvoiceProjectTemplate::$appendNameArr;
        $reDataArr['defaultAppendName'] = $info['append_name'] ?? -1;// 列表页默认状态

        // 是否合并开票1分开开票--不合并2合并开票
        $reDataArr['mergeGoods'] =  InvoiceProjectTemplate::$mergeGoodsArr;
        $reDataArr['defaultMergeGoods'] = $info['merge_goods'] ?? -1;// 列表页默认状态
