...
//            return view('admin.QualityControl.CompanyNews.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyNews.index', true
...
//            return view('admin.QualityControl.CompanyNews.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanyNews.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyNews.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanyNews.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_news/ajax_info",
     *     tags={"大后台-检验机构信息管理-企业其它"},
     *     summary="企业其它--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyNewsAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_news/ajax_save",
     *     tags={"大后台-检验机构信息管理-企业其它"},
     *     summary="企业其它--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyNewsAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_news_id_required"),
...
//        $this->InitParams($request);
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_news/ajax_alist",
     *     tags={"大后台-检验机构信息管理-企业其它"},
     *     summary="企业其它--列表",
     *     description="企业其它--列表......",
     *     operationId="adminQualityControlCompanyNewsAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//        return  CTAPICompanyNewsBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return  CTAPICompanyNewsBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_news/ajax_del",
     *     tags={"大后台-检验机构信息管理-企业其它"},
     *     summary="企业其它--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyNewsAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_news_id_required"),
