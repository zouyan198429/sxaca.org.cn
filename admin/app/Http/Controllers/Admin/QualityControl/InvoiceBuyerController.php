...
//            return view('admin.QualityControl.InvoiceBuyer.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.InvoiceBuyer.index', true
...
//            return view('admin.QualityControl.InvoiceBuyer.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.InvoiceBuyer.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.InvoiceBuyer.add', true
     ...
     *     operationId="adminQualityControlInvoiceBuyerAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoice_buyer/ajax_save",
     *     tags={"大后台-电子发票管理-发票配置购买方"},
     *     summary="发票配置购买方--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlInvoiceBuyerAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_buyer_id_required"),
...
//                    $saveData = array_merge($saveData, $addNewData);
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/invoice_buyer/ajax_alist",
     *     tags={"大后台-电子发票管理-发票配置购买方"},
     *     summary="发票配置购买方--列表",
     *     description="发票配置购买方--列表......",
     *     operationId="adminQualityControlInvoiceBuyerAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoice_buyer/ajax_del",
     *     tags={"大后台-电子发票管理-发票配置购买方"},
     *     summary="发票配置购买方--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlInvoiceBuyerAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoice_buyer_id_required"),
