...
class IndexController extends BasicController
{
     ...
     */
    public function index(Request $request, $course_id = 0)
    {
...
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseAdmin.index', true
            , 'doListPage', ['course_id' => $course_id], function (&$reDataArr) use ($request){
     ...
     * @author zouyan(305463219@qq.com)
     */
    public function basic(Request $request, $course_id = 0)
    {
...
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseAdmin.basic', true
            , '', [], function (&$reDataArr) use ($request, &$course_id){
                $reDataArr['course_id'] = $course_id;

                $courseInfo = $this->getCourseInfo($course_id);

                 $relationFormatConfigs = CTAPICourseBusiness::getRelationConfigs($request, $this, ['course_content' => '', 'resource_list' => ''], []);
                 CTAPICourseBusiness::formatRelationList( $request, $this, $courseInfo, $relationFormatConfigs);

                $reDataArr['info'] = $courseInfo;
                 // pr($reDataArr);
    ...
    public function doListPage(Request $request, &$reDataArr, $extendParams = []){
        ...
        // $id = $extendParams['params']['id'];
         $course_id = $extendParams['params']['course_id'];
