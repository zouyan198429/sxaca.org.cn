...
//            return view('admin.QualityControl.VodOrders.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.VodOrders.index', true
...
//            return view('admin.QualityControl.VodOrders.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.VodOrders.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.VodOrders.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.VodOrders.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    {
        return $this->exeDoPublicFun($request, 0, 8, 'admin.QualityControl.VodOrders.pay', true
...
//                $class_id = CommonRequest::getInt($request, 'class_id');
    ...
    {
        return $this->exeDoPublicFun($request, 0, 8, 'admin.QualityControl.VodOrders.pay_save', true
            , '', [], function (&$reDataArr) use ($request){
...
//                $class_id = CommonRequest::getInt($request, 'class_id');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_orders/ajax_info",
     *     tags={"大后台-视频点播-点播课程订单"},
     *     summary="点播课程订单--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlVodOrdersAjax_info",
     *     deprecated=false,
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_orders/ajax_save",
     *     tags={"大后台-视频点播-点播课程订单"},
     *     summary="点播课程订单--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlVodOrdersAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_orders_id_required"),
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/vod_orders/ajax_alist",
     *     tags={"大后台-视频点播-点播课程订单"},
     *     summary="点播课程订单--列表",
     *     description="点播课程订单--列表......",
     *     operationId="adminQualityControlVodOrdersAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/vod_orders/ajax_del",
     *     tags={"大后台-视频点播-点播课程订单"},
     *     summary="点播课程订单--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlVodOrdersAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_vod_orders_id_required"),
