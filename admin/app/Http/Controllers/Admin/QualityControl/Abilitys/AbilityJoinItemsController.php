...
//            return view('admin.QualityControl.AbilitysAdmin.AbilityJoinItems.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.AbilitysAdmin.AbilityJoinItems.index', true
...
//            return view('admin.QualityControl.AbilitysAdmin.AbilityJoinItems.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('admin.QualityControl.AbilitysAdmin.AbilityJoinItems.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.AbilitysAdmin.AbilityJoinItems.add', true
