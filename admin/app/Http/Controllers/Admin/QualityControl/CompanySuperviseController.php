...
//            return view('admin.QualityControl.CompanySupervise.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanySupervise.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICompanySuperviseBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICompanySuperviseBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CompanySupervise.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
//        return $this->exeDoPublicFun($request, 2048, 1, 'admin.QualityControl.CompanySupervise.select', true
//            , 'doListPage', [], function (&$reDataArr) use ($request){
//
//            });
//    }
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanySupervise.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanySupervise.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_supervise/ajax_info",
     *     tags={"大后台-检验机构信息管理平台-监督检查信息"},
     *     summary="监督检查信息--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanySuperviseAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_supervise_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_supervise"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_supervise"}
     */
    /**
     * ajax获得详情数据
     *
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_supervise/ajax_save",
     *     tags={"大后台-检验机构信息管理平台-监督检查信息"},
     *     summary="监督检查信息--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanySuperviseAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_supervise_id_required"),
...
//        }
                ...
                $resultDatas = CTAPICompanySuperviseBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_supervise/ajax_alist",
     *     tags={"大后台-检验机构信息管理平台-监督检查信息"},
     *     summary="监督检查信息--列表",
     *     description="监督检查信息--列表......",
     *     operationId="adminQualityControlCompanySuperviseAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_supervise_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_supervise"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        return  CTAPICompanySuperviseBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return  CTAPICompanySuperviseBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPICompanySuperviseBusiness::getList($request, $this, 1 + 0);
...
////        $this->InitParams($request);
////        CTAPICompanySuperviseBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanySuperviseBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_supervise/ajax_del",
     *     tags={"大后台-检验机构信息管理平台-监督检查信息"},
     *     summary="监督检查信息--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanySuperviseAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_supervise_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanySuperviseBusiness::delAjax($request, $this);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPICompanySuperviseBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
             // return CTAPICompanySuperviseBusiness::delAjax($request, $this);
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanySuperviseBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanySuperviseBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanySuperviseBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
