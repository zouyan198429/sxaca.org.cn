...
use App\Business\Controller\API\QualityControl\CTAPIPlatformDownFilesBusiness;
...
class PlatformDownFilesController extends BasicController
{
...
//            return view('admin.QualityControl.PlatformDownFiles.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.PlatformDownFiles.index', true
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            $reDataArr['province_kv'] = CTAPIPlatformDownFilesBusiness::getCityByPid($request, $this,  0);
////            $reDataArr['province_kv'] = CTAPIPlatformDownFilesBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
////            $reDataArr['province_id'] = 0;
////            return view('admin.QualityControl.PlatformDownFiles.select', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//        return $this->exeDoPublicFun($request, 2048, 1, 'admin.QualityControl.PlatformDownFiles.select', true
//            , 'doListPage', [], function (&$reDataArr) use ($request){
//
//            });
//    }
...
//            if ($id > 0) { // 获得详情数据
//                $operate = "修改";
//                $info = CTAPIPlatformDownFilesBusiness::getInfoData($request, $this, $id, [], '', []);
//            }
//            // $reDataArr = array_merge($reDataArr, $resultDatas);
//            $reDataArr['info'] = $info;
//            $reDataArr['operate'] = $operate;
//            return view('admin.QualityControl.PlatformDownFiles.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.PlatformDownFiles.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/platform_down_files/ajax_info",
     *     tags={"大后台-检验机构信息管理平台-表格下载"},
     *     summary="表格下载--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlPlatformDownFilesAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_platform_down_files_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_platform_down_files"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_platform_down_files"}
     */
    /**
     * ajax获得详情数据
     *
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/platform_down_files/ajax_save",
     *     tags={"大后台-检验机构信息管理平台-表格下载"},
     *     summary="表格下载--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlPlatformDownFilesAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_platform_down_files_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $resultDatas = CTAPIPlatformDownFilesBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
            });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/platform_down_files/ajax_alist",
     *     tags={"大后台-检验机构信息管理平台-表格下载"},
     *     summary="表格下载--列表",
     *     description="表格下载--列表......",
     *     operationId="adminQualityControlPlatformDownFilesAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_platform_down_files_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_platform_down_files"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPIPlatformDownFilesBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPIPlatformDownFilesBusiness::getRelationConfigs($request, $this, $handleKeyConfigArr, []),
            ];
            return  CTAPIPlatformDownFilesBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPIPlatformDownFilesBusiness::getList($request, $this, 1 + 0);
...
////        $this->InitParams($request);
////        CTAPIPlatformDownFilesBusiness::getList($request, $this, 1 + 0);
...
//                'relationFormatConfigs'=> CTAPIPlatformDownFilesBusiness::getRelationConfigs($request, $this, $handleKeyConfigArr, []),
//            ];
//            CTAPIPlatformDownFilesBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
//        });
//    }
...
////        $this->InitParams($request);
////        CTAPIPlatformDownFilesBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/platform_down_files/ajax_del",
     *     tags={"大后台-检验机构信息管理平台-表格下载"},
     *     summary="表格下载--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlPlatformDownFilesAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_platform_down_files_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIPlatformDownFilesBusiness::delAjax($request, $this);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPIPlatformDownFilesBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
//            return CTAPIPlatformDownFilesBusiness::delAjax($request, $this);
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIPlatformDownFilesBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIPlatformDownFilesBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIPlatformDownFilesBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
    ...
    public function doInfoPage(Request $request, &$reDataArr, $extendParams = []){
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPIPlatformDownFilesBusiness::getInfoData($request, $this, $id, [], '', $extParams);
        }
        // $reDataArr = array_merge($reDataArr, $resultDatas);
        $reDataArr['info'] = $info;
        $reDataArr['operate'] = $operate;
