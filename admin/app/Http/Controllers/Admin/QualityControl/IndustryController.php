...
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.Industry.index', true
            , 'doListPage', [], function (&$reDataArr) use ($request){

            }, self::REQUEST_API_POWER_NO_COMMON);
    }
...
//        }, $this->errMethod, $reDataArr, $this->errorView);
        ...
        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.Industry.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.Industry.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
