...
use App\Business\Controller\API\QualityControl\CTAPICompanyCertificateTypeBusiness;
...
class CompanyCertificateTypeController extends BasicController
{
...
//            return view('admin.QualityControl.CompanyCertificateType.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyCertificateType.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICompanyCertificateTypeBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICompanyCertificateTypeBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CompanyCertificateType.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanyCertificateType.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyCertificateType.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_certificate_type/ajax_info",
     *     tags={"大后台-用户信息-资质证书类型"},
     *     summary="资质证书类型--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyCertificateTypeAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_certificate_type_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_certificate_type"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_certificate_type"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPICompanyCertificateTypeBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_certificate_type/ajax_save",
     *     tags={"大后台-用户信息-资质证书类型"},
     *     summary="资质证书类型--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyCertificateTypeAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_certificate_type_id_required"),
...
//        }
                ...
                $resultDatas = CTAPICompanyCertificateTypeBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_certificate_type/ajax_alist",
     *     tags={"大后台-用户信息-资质证书类型"},
     *     summary="资质证书类型--列表",
     *     description="资质证书类型--列表......",
     *     operationId="adminQualityControlCompanyCertificateTypeAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_certificate_type_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_certificate_type"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICompanyCertificateTypeBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPICompanyCertificateTypeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanyCertificateTypeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanyCertificateTypeBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_certificate_type/ajax_del",
     *     tags={"大后台-用户信息-资质证书类型"},
     *     summary="资质证书类型--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyCertificateTypeAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_certificate_type_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanyCertificateTypeBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanyCertificateTypeBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanyCertificateTypeBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanyCertificateTypeBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
