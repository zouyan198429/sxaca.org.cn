...
//            return view('admin.QualityControl.Invoices.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.Invoices.index', true
...
//            return view('admin.QualityControl.Invoices.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.Invoices.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.Invoices.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/invoices/ajax_info",
     *     tags={"大后台-电子发票管理-发票主表"},
     *     summary="发票主表--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlInvoicesAjax_info",
     *     deprecated=false,
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoices/ajax_save",
     *     tags={"大后台-电子发票管理-发票主表"},
     *     summary="发票主表--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlInvoicesAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoices_id_required"),
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/invoices/ajax_alist",
     *     tags={"大后台-电子发票管理-发票主表"},
     *     summary="发票主表--列表",
     *     description="发票主表--列表......",
     *     operationId="adminQualityControlInvoicesAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/invoices/ajax_del",
     *     tags={"大后台-电子发票管理-发票主表"},
     *     summary="发票主表--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlInvoicesAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_invoices_id_required"),
