...
class OrderPayConfigController extends BasicController
{
...
//            return view('admin.QualityControl.OrderPayConfig.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.OrderPayConfig.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIOrderPayConfigBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIOrderPayConfigBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.OrderPayConfig.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.OrderPayConfig.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.OrderPayConfig.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_pay_config/ajax_info",
     *     tags={"大后台-收款设置-收款帐号"},
     *     summary="收款帐号--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlOrderPayConfigAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_config_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_order_pay_config"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_order_pay_config"}
     */
    /**
     * ajax获得详情数据
     *
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_pay_config/ajax_save",
     *     tags={"大后台-收款设置-收款帐号"},
     *     summary="收款帐号--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlOrderPayConfigAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_config_id_required"),
...
//                if(!empty($pay_method_ids)) $pay_method_ids = ',' . $pay_method_ids . ',';
                ...
                $saveData = [
                    'pay_company_name' => $pay_company_name,
                    'pay_key' => $pay_key,
...
//        }
                ...
                $resultDatas = CTAPIOrderPayConfigBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/order_pay_config/ajax_alist",
     *     tags={"大后台-收款设置-收款帐号"},
     *     summary="收款帐号--列表",
     *     description="收款帐号--列表......",
     *     operationId="adminQualityControlOrderPayConfigAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_config_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_order_pay_config"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        $result = CTAPIOrderPayConfigBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIOrderPayConfigBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/order_pay_config/ajax_del",
     *     tags={"大后台-收款设置-收款帐号"},
     *     summary="收款帐号--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlOrderPayConfigAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_order_pay_config_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPIOrderPayConfigBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIOrderPayConfigBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIOrderPayConfigBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIOrderPayConfigBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
