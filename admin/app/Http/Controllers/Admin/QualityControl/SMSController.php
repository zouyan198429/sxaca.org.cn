...
class SMSController extends BasicController
{
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/ajax_send_mobile_vercode",
     *     tags={"大后台-帐号注册登录"},
     *     summary="发送手机注册验证码",
     *     description="验证码2分钟内有效，过期请重新发送。未注册有效手机号。限:10次/天；30次/月；50次/半年；",
     *     operationId="adminSMSAjax_send_mobile_vercode",
     *     deprecated=false,
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/ajax_mobile_code_verify",
     *     tags={"大后台-帐号注册登录"},
     *     summary="发送手机注册验证码校验是否正确",
     *     description="验证码2分钟内有效，过期请重新发送。未注册有效手机号。限:10次/天；30次/月；50次/半年；",
     *     operationId="adminSMSAjax_mobile_code_verify",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/common_Parameter_mobile"),
