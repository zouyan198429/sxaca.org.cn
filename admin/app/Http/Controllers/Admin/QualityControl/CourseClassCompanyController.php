...
use App\Business\Controller\API\QualityControl\CTAPICourseClassCompanyBusiness;
use App\Business\Controller\API\QualityControl\CTAPISmsTemplateBusiness;
use App\Http\Controllers\WorksController;
use App\Models\QualityControl\CourseClassCompany;
use App\Services\Request\CommonRequest;
use App\Services\Tool;
use Illuminate\Http\Request;

class CourseClassCompanyController extends BasicController
{
...
//            return view('admin.QualityControl.CourseClassCompany.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseClassCompany.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICourseClassCompanyBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICourseClassCompanyBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CourseClassCompany.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
////            // $reDataArr = $this->reDataArr;
////            $reDataArr = array_merge($reDataArr, $this->reDataArr);
////            return view('admin.QualityControl.CourseClassCompany.add', $reDataArr);
////
////        }, $this->errMethod, $reDataArr, $this->errorView);
//
//        $pageNum = ($id > 0) ? 64 : 16;
//        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CourseClassCompany.add', true
...
//    }
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CourseClassCompany.info', false
            , '', ['id' => $id], function (&$reDataArr) use ($request, &$id){
                $extParams = [
                    // 'handleKeyArr' => $handleKeyArr,//一维数组，数数据需要处理的标记，每一个或类处理，根据情况 自定义标记，然后再处理函数中处理数据。
                    'relationFormatConfigs'=> CTAPICourseClassCompanyBusiness::getRelationConfigs($request, $this,
                        [
                            'company_name' => '',
                            'course_name' => '',
                            'class_name' => '',
                ...
                $info = CTAPICourseClassCompanyBusiness::getFVFormatList( $request,  $this, 4, 1
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_class_company/ajax_info",
     *     tags={"大后台-面授培训-培训班企业管理"},
     *     summary="培训班企业管理--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCourseClassCompanyAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_class_company_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_course_class_company"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_course_class_company"}
     */
    /**
     * ajax获得详情数据
     *
...
//        $info = CTAPICourseClassCompanyBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        return ajaxDataArr(1, $resultDatas, '');
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_class_company/ajax_save",
     *     tags={"大后台-面授培训-培训班企业管理"},
     *     summary="培训班企业管理--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCourseClassCompanyAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_class_company_id_required"),
...
//                $course_class_company_name = CommonRequest::get($request, 'course_class_company_name');
//                $simple_name = CommonRequest::get($request, 'simple_name');
//                $sort_num = CommonRequest::getInt($request, 'sort_num');
//
//                $saveData = [
//                    'course_class_company_name' => $course_class_company_name,
...
//                ];
//                $resultDatas = CTAPICourseClassCompanyBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
//                return ajaxDataArr(1, $resultDatas, '');
//        });
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_class_company/ajax_alist",
     *     tags={"大后台-面授培训-培训班企业管理"},
     *     summary="培训班企业管理--列表",
     *     description="培训班企业管理--列表......",
     *     operationId="adminQualityControlCourseClassCompanyAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_class_company_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_course_class_company"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICourseClassCompanyBusiness::getList($request, $this, 2 + 4);
        return $this->exeDoPublicFun($request, 4, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return  CTAPICourseClassCompanyBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPICourseClassCompanyBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICourseClassCompanyBusiness::getList($request, $this, 1 + 0);
        return $this->exeDoPublicFun($request, 4096, 8,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            CTAPICourseClassCompanyBusiness::getList($request, $this, 1 + 0, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        CTAPICourseClassCompanyBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_class_company/ajax_del",
     *     tags={"大后台-面授培训-培训班企业管理"},
     *     summary="培训班企业管理--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCourseClassCompanyAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_class_company_id_required"),
...
//    {
////        $this->InitParams($request);
////        return CTAPICourseClassCompanyBusiness::delAjax($request, $this);
//
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICourseClassCompanyBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICourseClassCompanyBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICourseClassCompanyBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//    }
    ...
    public function doListPage(Request $request, &$reDataArr, $extendParams = []){
        ...
        $reDataArr['payStatus'] =  CourseClassCompany::$payStatusArr;
        $reDataArr['defaultPayStatus'] = (!is_numeric($pay_status) || $pay_status <= 0 ) ? -1 : $pay_status;// 列表页默认状态

        // 班级状态1待开班2开班中4已作废8已结业
        $class_status = CommonRequest::getInt($request, 'class_status');// $hiddenOption = 8
        $reDataArr['classStatus'] =  CourseClassCompany::$classStatusArr;
