...
use App\Business\Controller\API\QualityControl\CTAPICourseLogBusiness;
...
class CourseLogController extends BasicController
{
...
//            return view('admin.QualityControl.CourseLog.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CourseLog.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICourseLogBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICourseLogBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CourseLog.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CourseLog.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CourseLog.add', true
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_log/ajax_info",
     *     tags={"大后台-面授培训-面授操作日志"},
     *     summary="面授操作日志--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCourseLogAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_log_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_course_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_course_log"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPICourseLogBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_log/ajax_save",
     *     tags={"大后台-面授培训-面授操作日志"},
     *     summary="面授操作日志--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCourseLogAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_log_id_required"),
...
//        }
                ...
                $resultDatas = CTAPICourseLogBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/course_log/ajax_alist",
     *     tags={"大后台-面授培训-面授操作日志"},
     *     summary="面授操作日志--列表",
     *     description="面授操作日志--列表......",
     *     operationId="adminQualityControlCourseLogAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_log_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_course_log"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICourseLogBusiness::getList($request, $this, 2 + 4);
...
//        $this->InitParams($request);
//        $result = CTAPICourseLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICourseLogBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICourseLogBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/course_log/ajax_del",
     *     tags={"大后台-面授培训-面授操作日志"},
     *     summary="面授操作日志--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCourseLogAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_course_log_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICourseLogBusiness::delAjax($request, $this);
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICourseLogBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICourseLogBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICourseLogBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
