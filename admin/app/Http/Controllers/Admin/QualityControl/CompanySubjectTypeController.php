...
class CompanySubjectTypeController extends BasicController
{
...
//            return view('admin.QualityControl.CompanySubjectType.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanySubjectType.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICompanySubjectTypeBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICompanySubjectTypeBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CompanySubjectType.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanySubjectType.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanySubjectType.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanySubjectType.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_subject_type/ajax_info",
     *     tags={"大后台-在线考试-试题分类"},
     *     summary="试题分类--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanySubjectTypeAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_type_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_subject_type"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_subject_type"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPICompanySubjectTypeBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_subject_type/ajax_save",
     *     tags={"大后台-在线考试-试题分类"},
     *     summary="试题分类--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanySubjectTypeAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_type_id_required"),
...
//                    if($company_id != $info['company_id']) throws('您没有此记录的操作权限');
                ...
                $resultDatas = CTAPICompanySubjectTypeBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_subject_type/ajax_alist",
     *     tags={"大后台-在线考试-试题分类"},
     *     summary="试题分类--列表",
     *     description="试题分类--列表......",
     *     operationId="adminQualityControlCompanySubjectTypeAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_type_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_subject_type"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICompanySubjectTypeBusiness::getList($request, $this, 2 + 4);
...
//            CTAPIAbbbBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPICompanySubjectTypeBusiness::getRelationConfigs($request, $this,
                    [
                        'company_info' => '',
                    ], []),
                // 'listHandleKeyArr' => ['priceIntToFloat'],
            ];
            return  CTAPICompanySubjectTypeBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPICompanySubjectTypeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanySubjectTypeBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanySubjectTypeBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_subject_type/ajax_del",
     *     tags={"大后台-在线考试-试题分类"},
     *     summary="试题分类--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanySubjectTypeAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_type_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanySubjectTypeBusiness::delAjax($request, $this);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true, '', [], function (&$reDataArr) use ($request){
            ...
            return CTAPICompanySubjectTypeBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanySubjectTypeBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanySubjectTypeBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanySubjectTypeBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPICompanySubjectTypeBusiness::getInfoData($request, $this, $id, [], '', $extParams);
