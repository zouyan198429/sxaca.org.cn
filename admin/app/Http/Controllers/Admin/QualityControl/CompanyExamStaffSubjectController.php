...
use App\Business\Controller\API\QualityControl\CTAPICompanyExamStaffSubjectBusiness;
...
class CompanyExamStaffSubjectController extends BasicController
{
...
//            return view('admin.QualityControl.CompanyExamStaffSubject.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanyExamStaffSubject.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICompanyExamStaffSubjectBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICompanyExamStaffSubjectBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CompanyExamStaffSubject.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanyExamStaffSubject.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanyExamStaffSubject.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanyExamStaffSubject.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_exam_staff_subject/ajax_info",
     *     tags={"大后台-在线考试-考次人员试题答案"},
     *     summary="考次人员试题答案--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanyExamStaffSubjectAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_exam_staff_subject_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_exam_staff_subject"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_exam_staff_subject"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPICompanyExamStaffSubjectBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_exam_staff_subject/ajax_save",
     *     tags={"大后台-在线考试-考次人员试题答案"},
     *     summary="考次人员试题答案--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanyExamStaffSubjectAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_exam_staff_subject_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            , '', [], function (&$reDataArr) use ($request){
                ...
                $company_exam_staff_subject_name = CommonRequest::get($request, 'company_exam_staff_subject_name');
                $simple_name = CommonRequest::get($request, 'simple_name');
                $sort_num = CommonRequest::getInt($request, 'sort_num');

                $saveData = [
                    'company_id' => $company_id,
                    'company_exam_staff_subject_name' => $company_exam_staff_subject_name,
...
//                    if($company_id != $info['company_id']) throws('您没有此记录的操作权限');
                ...
                $resultDatas = CTAPICompanyExamStaffSubjectBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
                return ajaxDataArr(1, $resultDatas, '');
        });
    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_exam_staff_subject/ajax_alist",
     *     tags={"大后台-在线考试-考次人员试题答案"},
     *     summary="考次人员试题答案--列表",
     *     description="考次人员试题答案--列表......",
     *     operationId="adminQualityControlCompanyExamStaffSubjectAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_exam_staff_subject_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_exam_staff_subject"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICompanyExamStaffSubjectBusiness::getList($request, $this, 2 + 4);
...
//            CTAPIAbbbBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPICompanyExamStaffSubjectBusiness::getRelationConfigs($request, $this,
                    [
                        'company_info' => '',
                    ], []),
                // 'listHandleKeyArr' => ['priceIntToFloat'],
            ];
            return  CTAPICompanyExamStaffSubjectBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPICompanyExamStaffSubjectBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanyExamStaffSubjectBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanyExamStaffSubjectBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_exam_staff_subject/ajax_del",
     *     tags={"大后台-在线考试-考次人员试题答案"},
     *     summary="考次人员试题答案--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanyExamStaffSubjectAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_exam_staff_subject_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanyExamStaffSubjectBusiness::delAjax($request, $this);
...
//            return CTAPICompanyExamStaffSubjectBusiness::delAjax($request, $this);
            ...
            return CTAPICompanyExamStaffSubjectBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanyExamStaffSubjectBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanyExamStaffSubjectBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanyExamStaffSubjectBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPICompanyExamStaffSubjectBusiness::getInfoData($request, $this, $id, [], '', $extParams);
