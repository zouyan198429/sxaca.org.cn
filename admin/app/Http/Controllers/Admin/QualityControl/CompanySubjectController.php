...
use App\Business\Controller\API\QualityControl\CTAPICompanySubjectBusiness;
use App\Business\Controller\API\QualityControl\CTAPICompanySubjectTypeBusiness;
...
class CompanySubjectController extends BasicController
{
...
//            return view('admin.QualityControl.CompanySubject.index', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
        return $this->exeDoPublicFun($request, 1, 1, 'admin.QualityControl.CompanySubject.index', true
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPICompanySubjectBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPICompanySubjectBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.CompanySubject.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            return view('admin.QualityControl.CompanySubject.add', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);

        $pageNum = ($id > 0) ? 64 : 16;
        return $this->exeDoPublicFun($request, $pageNum, 1,'admin.QualityControl.CompanySubject.add', true
    ...
    {
        return $this->exeDoPublicFun($request, 17179869184, 1,'admin.QualityControl.CompanySubject.info', true
            , 'doInfoPage', ['id' => $id], function (&$reDataArr) use ($request){
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/company_subject/ajax_info",
     *     tags={"大后台-在线考试-试题"},
     *     summary="试题--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="adminQualityControlCompanySubjectAjax_info",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_company_subject"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_company_subject"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    public function ajax_info(Request $request){
        ...
        $info = CTAPICompanySubjectBusiness::getInfoData($request, $this, $id, [], '', []);
...
//        });
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_subject/ajax_save",
     *     tags={"大后台-在线考试-试题"},
     *     summary="试题--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="adminQualityControlCompanySubjectAjax_save",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_id_required"),
...
//        $this->InitParams($request);
        ...
        return $this->exeDoPublicFun($request, $pageNum, 4,'', true
            ...
            return CTAPICompanySubjectBusiness::replaceInfo($request, $this, 0);
        });
    }

    /**
     * @OA\Get(
     *     path="/api/admin/company_subject/ajax_alist",
     *     tags={"大后台-在线考试-试题"},
     *     summary="试题--列表",
     *     description="试题--列表......",
     *     operationId="adminQualityControlCompanySubjectAjax_alist",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_company_subject"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPICompanySubjectBusiness::getList($request, $this, 2 + 4);
...
//            CTAPIAbbbBusiness::mergeRequest($request, $this, $mergeParams);
            $extParams = [
                ...
                'relationFormatConfigs'=> CTAPICompanySubjectBusiness::getRelationConfigs($request, $this,
                    [
                        'company_info' => '',
                        'analyse_answer' => '',
                        'subject_answer' => '',
                    ], []),
                'listHandleKeyArr' => ['initTypeNoText'],// , 'priceIntToFloat'
                'finalHandleKeyArr'=> ['sysFormatData'],
            ];
            return  CTAPICompanySubjectBusiness::getList($request, $this, 2 + 4, [], [], $extParams);
        });
    }
...
//        $this->InitParams($request);
//        $result = CTAPICompanySubjectBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanySubjectBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPICompanySubjectBusiness::importTemplate($request, $this);
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/company_subject/ajax_del",
     *     tags={"大后台-在线考试-试题"},
     *     summary="试题--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="adminQualityControlCompanySubjectAjax_del",
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_company_subject_id_required"),
    ...
    {
//        $this->InitParams($request);
//        return CTAPICompanySubjectBusiness::delAjax($request, $this);
...
//            return CTAPICompanySubjectBusiness::delAjax($request, $this);
            ...
            return CTAPICompanySubjectBusiness::delCustomizeAjax($request,  $this, $organize_id, [], '');
        });
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPICompanySubjectBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPICompanySubjectBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPICompanySubjectBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
///
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        // 获得试题分类KV值
        $reDataArr['type_no_kv'] = CTAPICompanySubjectTypeBusiness::getListKV($request, $this, ['key' => 'type_no', 'val' => 'type_name'], [
            'sqlParams' => ['orderBy' => CompanySubject::ORDER_BY]// 'where' => [['open_status', 1]],
        ]);
        $reDataArr['defaultTypeNo'] = $info['type_no'] ?? -1;// 默认

        // 题目类型1单选；2多选；4判断；8问答【人工打分】；16填空题【人工打分】；32填空题【确切答案】格式：1+1={{[2]}}；1+1>={{[0<|=|>1<|=|>2]}}
        $reDataArr['subjectType'] =  CompanySubject::SUBJECT_TYPE_ARR;
        $reDataArr['defaultSubjectType'] = $info['subject_type'] ?? -1;// 列表页默认状态

        // 正确答案;4判断时：1正确2错误
        $reDataArr['answer'] =  CompanySubject::ANSWER_ARR;
        $reDataArr['defaultAnswer'] = $info['answer'] ?? -1;// 列表页默认状态

        // 开通状态1开通；2关闭；4作废【过时关闭】；
        $reDataArr['openStatus'] =  CompanySubject::OPEN_STATUS_ARR;
        $reDataArr['defaultOpenStatus'] = $info['open_status'] ?? -1;// 列表页默认状态

        $reDataArr['egFormat'] = CompanySubject::SUBJECT_EG_FORMAT;
...
//        $reDataArr['defaultAdminType'] = -1;// 列表页默认状态
        ...
        if ($id > 0) { // 获得详情数据
            ...
            $info = CTAPICompanySubjectBusiness::getInfoData($request, $this, $id, [], '', $extParams);
