...
class CompanyPaperSubject extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'company_paper_subject';
    ...
    // 表里没有的字段
    protected $appends = ['subject_updated_text'];
    ...
    {
        return $this->hasOne('App\Models\QualityControl\CompanySubject', 'subject_id', 'id');
    }
}
