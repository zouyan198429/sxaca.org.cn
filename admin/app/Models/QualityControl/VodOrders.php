...
class VodOrders extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    ];
    ...
    //****************数据据缓存**相关的***结束********************************************
     ...
     public static $IntPriceFields = ['price', 'price_total'];//[有则设置] 表中整型表示价格的字段数组 -- 一维数组，目的：方便统一把数据中的字段转浮点数或转整数
...
//    public static $primaryKeyValType = 1;
    ...
    // 表里没有的字段
    protected $appends = ['admin_type_text', 'company_grade_text', 'pay_status_text', 'company_status_text', 'effectively_day_text'];
     ...
     * 获取点播课程销量统计【流水】---一维
     */
    public function vodSales()
    {
        return $this->hasOne('App\Models\QualityControl\VodSales', 'order_no', 'order_no');
    }
}
