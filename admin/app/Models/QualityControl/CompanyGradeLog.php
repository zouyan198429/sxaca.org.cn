...
class CompanyGradeLog extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'company_grade_log';
    ...
    // [原始]企业--会员等级1非会员  2会员  4理事  8常务理事   16理事长
    public static $companyGradeOldArr = [
        '1' => '非会员',
        '2' => '会员',
        '4' => '理事',
        '8' => '常务理事',
    ...
    // 表里没有的字段
    protected $appends = ['company_grade_text', 'company_grade_old_text'];
     ...
     * @return string
     */
    public function getCompanyGradeOldTextAttribute()
    {
        return static::$companyGradeOldArr[$this->company_grade_old] ?? '';
    }

    /**
     * 获取企业会员等级配置-一维
     */
    public function companyGradeConfig()
    {
        return $this->belongsTo('App\Models\QualityControl\CompanyGradeConfig', 'grade_config_id', 'id');
    }
}
