...
class CourseClassCompany extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
// 拥有者类型1平台2企业4个人
    ...
    // 表里没有的字段
    protected $appends = ['admin_type_text', 'pay_status_text', 'class_status_text'];
     ...
     * @var string
     */
    protected $table = 'course_class_company';
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseOrderStaff', 'class_company_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseLog', 'class_company_id', 'id');
    }
