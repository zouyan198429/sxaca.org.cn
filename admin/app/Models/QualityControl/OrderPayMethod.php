...
class OrderPayMethod extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'order_pay_method';
    ...
    {
        return $this->hasMany('App\Models\QualityControl\OrderPay', 'pay_method', 'pay_method');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\OrderFlow', 'pay_method', 'pay_method');
    }
