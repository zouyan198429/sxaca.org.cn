...
class CompanySubjectAnalyse extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $cacheExpire = 60 * 60 * 24 * 10;// 10 天 缓存的时间长度 ; 值<= 0时，会使用 public.DBDataCache.expire 配置
    ...
    public static $cacheType = 0;// (1 | 2);// 0
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'company_subject_analyse';
...
//    }
    ...
    public function subject()
    {
        return $this->belongsTo('App\Models\QualityControl\CompanySubject', 'subject_id', 'id')->withDefault();
    }
}
