...
class SmsLog extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    // 表里没有的字段
    protected $appends = ['sms_status_text', 'template_type_text', 'send_type_text'];
    ...
    {
        return static::$templateTypeArr[$this->template_type] ?? '';
    }
