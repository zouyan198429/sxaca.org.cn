...
class AbilityJoinItems extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $cacheSimple = 'U';// 表名简写,为空，则使用表名
    ...
    public static $cacheVersion = 'V23';// 内容随意改[可0{空默认为0}开始自增]- 如果运行过程中，有直接对表记录进行修改，增加或修改字段名，则修改此值，使表记录的相关缓存过期。
...
//    public static $primaryKeyValType = 1;
    ...
    public static $statusArr = [
        '1' => '已报名',// 报名后初始状态
        '2' => '进行中',// 进行中-- 初次取样后、补测取样后
//        '2' => '已取样',
//        '4' => '已传数据',
        '8' => '待补测取样',// 只要判定了就是这个状态--满意的待发证操作 ；注意：补测取样后改为2状态
        '16' => '待发证',
        '32' => '无证书',// 最终状态 【补测不满意】---已完成[非满意]
        '64' => '已发证',// 满意已发证--已完成[满意]
    ];
...
//        '3' => '补测3',
    ...
    // 是否上传数据1待传 --未传  2 已传; 4 补测待传 ; 8 补测已传
    ...
    // 是否评定1待评  2 已评; 4 补测待评 ; 8 补测已评
    public static $judgeStatusArr = [
        '1' => '待评[初测]',
        '2' => '已评[初测]',// 初判定后的状态
        '4' => '待评[补测]',// 注意：补测取样后变为此状态
        '8' => '已评[补测]',
    ];
