...
class CompanyNewContent extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'company_new_content';
    ...
    {
        return $this->belongsTo('App\Models\QualityControl\CompanyNews', 'new_id', 'id');
    }
}
