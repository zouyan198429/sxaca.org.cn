...
class InvoiceTemplateHistory extends InvoiceTemplate
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'invoice_template_history';
    ...
    {
        return $this->hasMany('App\Models\QualityControl\Invoices', 'invoice_template_id_history', 'id');
    }
