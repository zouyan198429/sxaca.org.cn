...
class LiveNoticeContent extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'live_notice_content';
    ...
    {
        return $this->belongsTo('App\Models\QualityControl\LiveNotice', 'live_notice_id', 'id')->withDefault();
    }
}
