...
class AlipayAuthToken extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'alipay_auth_token';

    // 操作状态(1待换取令牌2已换取令牌4作废【已刷新令牌】)
    public static $operateStatusArr = [
        '1' => '待换取令',
        '2' => '已换取令牌',
        '4' => '作废',
    ];
    ...
    // 表里没有的字段
    protected $appends = ['operate_status_text'];
     ...
     * @return string
     */
    public function getOperateStatusTextAttribute()
    {
        return static::$operateStatusArr[$this->operate_status] ?? '';
    }
