...
class SmsModule extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    {
        return $this->hasMany('App\Models\QualityControl\SmsTemplate', 'module_id', 'id');
    }

    /**
     * 获取短信模板所属模块参数-二维
     */
    public function smsModuleParams()
    {
        return $this->hasMany('App\Models\QualityControl\SmsModuleParams', 'module_id', 'id');
    }
}
