...
class LiveNotice extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * 获取关联到的内容---一维
     */
    public function liveNoticeContent()
    {
        return $this->hasOne('App\Models\QualityControl\LiveNoticeContent', 'live_notice_id', 'id');
    }
}
