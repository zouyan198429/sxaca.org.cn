...
class CompanyPaperCategory extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'company_paper_category';

    // subject_order_type 试题顺序1固定顺序2随机顺序4试卷指定顺序
    const SUBJECT_ORDER_TYPE_FIXED = CompanyPaper::SUBJECT_ORDER_TYPE_FIXED;
    const SUBJECT_ORDER_TYPE_RANDOM = CompanyPaper::SUBJECT_ORDER_TYPE_RANDOM;
    const SUBJECT_ORDER_TYPE_PAPER = 4;
    const SUBJECT_ORDER_TYPE_ARR = [
        self::SUBJECT_ORDER_TYPE_FIXED => '固定顺序',
        self::SUBJECT_ORDER_TYPE_RANDOM => '随机顺序',
        self::SUBJECT_ORDER_TYPE_PAPER => '试卷指定顺序',
    ];

    // subject_updated 试题是否有更新1没有 ；2有更新【修改或删除】--需要人工去判断是否更新过来;4有更新【删除】
    const SUBJECT_UPDATED_NO = CompanyPaper::SUBJECT_UPDATED_NO;
    const SUBJECT_UPDATED_YES = CompanyPaper::SUBJECT_UPDATED_YES;
    const SUBJECT_UPDATED_DELED = CompanyPaper::SUBJECT_UPDATED_DELED;
    const SUBJECT_UPDATED_ARR = CompanyPaper::SUBJECT_UPDATED_ARR;

    // 表里没有的字段
    protected $appends = ['subject_order_type_text', 'subject_updated_text'];
