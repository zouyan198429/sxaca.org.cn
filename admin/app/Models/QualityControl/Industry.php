...
class Industry extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    // 其它具体的类可以在自己的类中 继承或 重写此常量 -- 只对外提供使用
     const ORDER_BY = ['sort_num' => 'asc', 'id' => 'desc'];// ['sort_num' => 'desc', 'id' => 'desc'];// ['id' => 'desc'];
    ...
    {
        return $this->hasMany('App\Models\QualityControl\Staff', 'company_industry_id', 'id');
    }
