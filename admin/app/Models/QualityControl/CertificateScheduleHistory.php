...
class CertificateScheduleHistory extends CertificateSchedule
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'certificate_schedule_history';

    /**
     * 获取所属企业检验检测机构资质认定证书--一维
     */
    public function certificateSchedule()
    {
        return $this->belongsTo('App\Models\QualityControl\CertificateSchedule', 'certificate_schedule_id', 'id');
    }
}
