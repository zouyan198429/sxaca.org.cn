...
class OrderPay extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    ];
    ...
    // 操作类型1用户操作2平台操作
    public static $operateTypeArr = [
        '1' => '用户操',
        '2' => '平台操作',
    ];

    // 冻结状态0不用冻结1已冻结2已解冻
    public static $frozenStatusArr = [
        '0' => '正常',
        '1' => '已冻结',
        '2' => '已解冻',
    ];
    ...
    {
        return static::$orderTypeArr[$this->order_type] ?? '';
    }
...
//    }
    ...
    {
        return static::$payTypeArr[$this->pay_type] ?? '';
    }
    /**
     * 获取操作类型文字
     *
    ...
    {
        return static::$operateTypeArr[$this->operate_type] ?? '';
    }
    ...
    {
        return static::$frozenStatusArr[$this->frozen_status] ?? '';
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\OrderFlow', 'pay_order_no', 'pay_order_no');
    }
