...
class ApiLog extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    public static $responseLevelArr = [
        '1' => '超光速(半秒内)',
        '2' => '光速(1秒内)',
        '4' => '极速(2秒内)',
        '8' => '普速(4秒内)',
    ...
    // 表里没有的字段
    protected $appends = ['do_status_text', 'response_level_text'];
     ...
     * @return string
     */
    public function getDoStatusTextAttribute()
    {
        return static::$doStatusArr[$this->do_status] ?? '';
    }
     ...
     * @return string
     */
    public function getResponseLevelTextAttribute()
    {
         return static::$responseLevelArr[$this->response_level] ?? '';
    }
}
