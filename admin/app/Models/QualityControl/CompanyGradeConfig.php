...
class CompanyGradeConfig extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    // 其它具体的类可以在自己的类中 继承或 重写此常量 -- 只对外提供使用
     const ORDER_BY = ['begin_date' => 'desc', 'id' => 'desc'];// ['sort_num' => 'desc', 'id' => 'desc'];// ['id' => 'desc'];
     ...
     * @var string
     */
    protected $table = 'company_grade_config';
    ...
    // 有效状态1待生效 2已作废[时间过期未审核或未通过]  4已生效  8已过效
    public static $validStatusArr = [
        '1' => '待生效',
        '2' => '已作废',// 时间过期未审核或未通过
        '4' => '已生效',
        '8' => '已完成',
    ...
    // [添加记录时]企业--会员等级1非会员  2会员  4理事  8常务理事   16理事长
    public static $companyGradeAddArr = [
        '1' => '非会员',
        '2' => '会员',
        '4' => '理事',
        '8' => '常务理事',
    ...
    // [更改时的] 企业--会员等级1非会员  2会员  4理事  8常务理事   16理事长
    public static $companyGradeFinalArr = [
        '1' => '非会员',
        '2' => '会员',
        '4' => '理事',
        '8' => '常务理事',
    ...
    // 表里没有的字段
    protected $appends = ['open_status_text', 'company_grade_text', 'valid_status_text', 'company_grade_add_text', 'company_grade_final_text'];
    ...
    {
        return static::$validStatusArr[$this->valid_status] ?? '';
    }
     ...
     * @return string
     */
    public function getCompanyGradeAddTextAttribute()
    {
        return static::$companyGradeAddArr[$this->company_grade_add] ?? '';
    }
     ...
     * @return string
     */
    public function getCompanyGradeFinalTextAttribute()
    {
        return static::$companyGradeFinalArr[$this->company_grade_final] ?? '';
    }

    /**
     * 获取操作日志-二维
     */
    public function companyGradeLog()
    {
        return $this->hasMany('App\Models\QualityControl\CompanyGradeLog', 'grade_config_id', 'id');
    }
}
