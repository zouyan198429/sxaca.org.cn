...
class InvoiceProjectTemplate extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'invoice_project_template';
    ...
    public static $appendNameArr = [
        '1' => '不拼接',
        '2' => '拼接',
    ];

    // 是否合并开票1分开开票--不合并2合并开票
    public static $mergeGoodsArr = [
        '2' => '合并',
        '1' => '不合并',
    ];

    // 表里没有的字段
    protected $appends = ['open_status_text', 'yhzcbs_text', 'lslbs_text', 'append_name_text', 'merge_goods_text'];
     ...
     * @return string
     */
    public function getAppendNameTextAttribute()
    {
        return static::$appendNameArr[$this->append_name] ?? '';
    }
     ...
     * @return string
     */
    public function getMergeGoodsTextAttribute()
    {
        return static::$mergeGoodsArr[$this->merge_goods] ?? '';
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\InvoiceProject', 'invoice_project_template_id', 'id');
    }
}
