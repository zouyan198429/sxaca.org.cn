...
class InvoiceOrder extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    {
        return $this->hasMany('App\Models\QualityControl\Orders', 'order_no', 'order_no');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\Invoices', 'order_num', 'order_num');
    }
}
