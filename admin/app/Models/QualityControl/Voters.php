...
class Voters extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    // 表里没有的字段
    protected $appends = ['group_type_text'];
    ...
    {
        return static::$groupTypeArr[$this->group_type] ?? '';
    }
    ...
    {
        return $this->hasOne('App\Models\QualityControl\VoterGroup', 'group_no_id', 'id');
    }
}
