...
//    }
    ...
    {
        return static::$orderStatusArr[$this->order_status] ?? '';
    }
...
//    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseOrderStaff', 'order_no', 'order_no');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\OrderPay', 'order_no', 'order_no');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\OrderFlow', 'order_no', 'order_no');
    }
