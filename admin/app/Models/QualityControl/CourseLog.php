...
class CourseLog extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    {
        return $this->belongsTo('App\Models\QualityControl\CourseOrder', 'course_order_id', 'id');
    }
    ...
    {
        return $this->belongsTo('App\Models\QualityControl\CourseOrderStaff', 'course_staff_id', 'id');
    }
