...
class InvoiceBuyerHistory extends InvoiceBuyer
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'invoice_buyer_history';
    ...
    {
        return $this->hasMany('App\Models\QualityControl\Invoices', 'invoice_buyer_id_history', 'id');
    }
}
