...
class Course extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    ];
    ...
    //****************数据据缓存**相关的***结束********************************************
     ...
     public static $IntPriceFields = ['price_member', 'price_general'];//[有则设置] 表中整型表示价格的字段数组 -- 一维数组，目的：方便统一把数据中的字段转浮点数或转整数
...
//    ];
    ...
    // 表里没有的字段
    protected $appends = ['status_online_text'];// , 'pay_method_text'
...
//    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseOrder', 'course_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseClass', 'course_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseClassCompany', 'course_order_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\QualityControl\CourseOrderStaff', 'course_id', 'id');
    }
    ...
    {
        return $this->hasOne('App\Models\QualityControl\CourseContent', 'course_id', 'id');
    }
