...
class SmsModuleParamsCommon extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'sms_module_params_common';

    // 参数类型1日期时间、2固定值
    public static $paramTypeArr = [
        '1' => '日期时间',
        '2' => '固定值',
    ];

    // 表里没有的字段
    protected $appends = ['param_type_text'];
     ...
     * @return string
     */
    public function getParamTypeTextAttribute()
    {
        return static::$paramTypeArr[$this->param_type] ?? '';
    }
}
