...
class InvoiceOrderFlow extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    ];
    //****************数据据缓存**相关的***结束********************************************
     ...
     public static $IntPriceFields = ['hjse', 'hjje', 'jshj'];//[有则设置] 表中整型表示价格的字段数组 -- 一维数组，目的：方便统一把数据中的字段转浮点数或转整数
...
//    public static $primaryKeyValType = 1;
     ...
     * @var string
     */
    protected $table = 'invoice_order_flow';
    ...
    // 表里没有的字段
    protected $appends = ['order_type_text', 'kplx_text', 'itype_text'];
