...
class VodSales extends BasePublicModel
{
    //****************数据据缓存**相关的***开始********************************************
...
//    public static $primaryKeyValType = 1;
    ...
    {
        return $this->hasOne('App\Models\QualityControl\VodVideo', 'vod_video_id', 'id');
    }
    ...
    {
        return $this->belongsTo('App\Models\QualityControl\VodOrders', 'order_no', 'order_no')->withDefault();
    }
}
