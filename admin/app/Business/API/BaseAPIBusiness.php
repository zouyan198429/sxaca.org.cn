...
class BaseAPIBusiness extends BaseBusiness
{
...
//                ['company_id', $company_id]
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function ModifyByQueyBSNS($company_id, $model_name, $saveData, $queryParams, $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::ModifyByQueyApi($model_name, $saveData, $queryParams, $company_id, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function firstOrCreateBSNS($company_id, $model_name, $searchConditon, $updateFields, $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::firstOrCreateApi($model_name, $searchConditon, $updateFields, $company_id, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function ajaxGetQueryListBSNS($company_id, $model_name, $queryParams, $relations, $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::ajaxGetQueryListApi($model_name, $company_id, $queryParams, $relations, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function createBathBSNS($company_id, $model_name, $saveData= [], $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::createBathApi($model_name, $saveData, $company_id, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function createBathByPrimaryKeyBSNS($company_id, $model_name, $saveData= [], $primaryKey = 'id', $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::createBathByPrimaryKeyApi($model_name, $saveData, $primaryKey, $company_id, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function incDecByQueyBSNS($company_id, $model_name, $incDecType = 'dec', $incDecField = '', $incDecVal = 0, $saveData = [], $queryParams = '', $notLog = 0, $modifFields = []){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::incDecByQueyApi($model_name, $queryParams, $incDecType, $incDecField, $incDecVal, $saveData, $company_id, $notLog, $modifFields);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function bathIncDecByArrBSNS($company_id, $model_name, $saveData = [], $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::bathIncDecByArrApi($model_name, $saveData, $company_id, $notLog);
    }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function detachById($company_id, $model_name, $id, $detachParams, $notLog = 0){
        // $company_id = $controller->company_id;
        if(empty($model_name)) $model_name = static::$model_name;
        static::GetAPIObj($APIObj);
        return $APIObj::detachByIdApi($model_name, $id, $detachParams, $company_id, $notLog);
    }
    ...
    public static function updateOrCreate($modelName, $searchConditon, $updateFields, $companyId = null , $notLog = 0){
        ...
        $mustFields = [];//
        $saveData = array_merge($searchConditon, $updateFields);
        static::judgeDBDataThrowErr($judgeType,$saveData, $mustFields, 1);
