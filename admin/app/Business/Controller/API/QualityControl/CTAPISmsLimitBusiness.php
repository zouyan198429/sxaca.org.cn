...
use App\Models\QualityControl\SmsLimit;
...
class CTAPISmsLimitBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\SmsLimitAPI';
    public static $table_name = 'sms_limit';// 表名称
    public static $record_class = __CLASS__;// 当前的类名称 App\Business\***\***\**\***
    public static $orderBy = SmsLimit::ORDER_BY;// ['valid_second' => 'asc', 'id' => 'desc'];// 默认的排序字段数组 ['id' => 'desc']--默认 或 ['sort_num' => 'desc', 'id' => 'desc']
