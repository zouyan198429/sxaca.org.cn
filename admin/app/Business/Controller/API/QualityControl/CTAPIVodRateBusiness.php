...
class CTAPIVodRateBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\VodRateAPI';
...
//        }
    ...
    public static function joinListParams(Request $request, Controller $controller, &$queryParams, $notLog = 0){
        ...
        $rate_no = CommonRequest::get($request, 'rate_no');
        if(strlen($rate_no) > 0 && !in_array($rate_no, [0, '-1']))  Tool::appendParamQuery($queryParams, $rate_no, 'rate_no', [0, '0', ''], ',', false);
