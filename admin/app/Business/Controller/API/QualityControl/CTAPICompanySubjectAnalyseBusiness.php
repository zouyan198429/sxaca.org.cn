...
class CTAPICompanySubjectAnalyseBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\CompanySubjectAnalyseAPI';
...
//                static::getRelationSqlParams(['where' => [['admin_type', 2]]], $extendParams, 'company_info'), '', []),
    ...
    public static function getRelationConfigReturnData(Request $request, Controller $controller, $return_num = 0){
        ...
        if(($return_num & 2) == 2){// 给上一级返回名称 analyse_answer 下标
            $one_field = ['key' => 'analyse_answer', 'return_type' => 2, 'ubound_name' => 'analyse_answer', 'split' => '、'];// 获得名称
