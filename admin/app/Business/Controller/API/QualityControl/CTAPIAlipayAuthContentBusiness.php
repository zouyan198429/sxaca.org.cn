...
class CTAPIAlipayAuthContentBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\AlipayAuthContentAPI';
    public static $table_name = 'alipay_auth_content';// 表名称
...
//        }
    ...
    public static function joinListParams(Request $request, Controller $controller, &$queryParams, $notLog = 0){
        ...
        if(strlen($status) > 0 && !in_array($status, [0, '-1']))  Tool::appendParamQuery($queryParams, $status, 'status', [0, '0', ''], ',', false);
