...
class CTAPIAbilityJoinItemsResultsInstrumentBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\AbilityJoinItemsResultsInstrumentAPI';
