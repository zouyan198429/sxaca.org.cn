...
class CTAPICompanyContentBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\CompanyContentAPI';
...
//    ];
    ...
    public static function getRelationConfigReturnData(Request $request, Controller $controller, $return_num = 0){
        ...
        if(($return_num & 2) == 2){// 给上一级返回名称 company_name 下标
            $one_field = ['key' => 'company_content', 'return_type' => 2, 'ubound_name' => 'company_content', 'split' => '、'];// 获得名称
