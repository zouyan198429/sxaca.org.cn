...
class CTAPIPlatformDownFilesBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\PlatformDownFilesAPI';
    ...
    public static function getRelationConfigs(Request $request, Controller $controller, $relationKeys = [], $extendParams = []){
        ...
        $relationFormatConfigs = [
            ...
            'resource_list' => CTAPIResourceBusiness::getTableRelationConfigInfo($request, $controller
                ...
                static::getRelationSqlParams(['where' => [['column_type', 128]]], $extendParams, 'resource_list'), ''
