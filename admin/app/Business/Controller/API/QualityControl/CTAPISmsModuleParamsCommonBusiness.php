...
class CTAPISmsModuleParamsCommonBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\SmsModuleParamsCommonAPI';
    public static $table_name = 'sms_module_params_common';// 表名称
    public static $record_class = __CLASS__;// 当前的类名称 App\Business\***\***\**\***
    public static $orderBy = SmsModuleParamsCommon::ORDER_BY;// ['sort_num' => 'desc', 'id' => 'desc'];// 默认的排序字段数组 ['id' => 'desc']--默认 或 ['sort_num' => 'desc', 'id' => 'desc']
...
//        }
    ...
    public static function joinListParams(Request $request, Controller $controller, &$queryParams, $notLog = 0){
        ...
        if(strlen($param_type) > 0 && !in_array($param_type, [0, '-1']))  Tool::appendParamQuery($queryParams, $param_type, 'param_type', [0, '0', ''], ',', false);
