...
class CTAPICompanyNewsBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\QualityControl\CompanyNewsAPI';
...
//    ];
    ...
    public static function getRelationConfigs(Request $request, Controller $controller, $relationKeys = [], $extendParams = []){
        ...
        $relationFormatConfigs = [
            ...
            // 获得详细内容
            'new_content' => CTAPICompanyNewContentBusiness::getTableRelationConfigInfo($request, $controller
                , ['id' => 'new_id']
                , 1, 2
                ,'','',
                CTAPICompanyNewContentBusiness::getRelationConfigs($request, $controller,
                    static::getUboundRelation($relationArr, 'new_content'),
                    static::getUboundRelationExtendParams($extendParams, 'new_content')),
                static::getRelationSqlParams([], $extendParams, 'new_content'), '', []),
        ];
