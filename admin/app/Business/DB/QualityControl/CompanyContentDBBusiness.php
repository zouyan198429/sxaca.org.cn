 ...
 *
 */
class CompanyContentDBBusiness extends BasePublicDBBusiness
{
...
//        }
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function getCompanyContentCount($company_id = 0){
        // 更新数
//        $queryParams = [
//            'where' => [
//                ['company_id', $company_id],
...
//            ];
            ...
            if(!empty($organizeIds)){
                foreach($organizeIds as $organizeId){
                    // 根据企业id更企业能力范围数
                    StaffDBBusiness::updateCompanyContentNum($organizeId);;
                }
            }
        });
        return $id;
