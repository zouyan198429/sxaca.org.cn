 ...
 *
 */
class CompanyPaperCategoryDBBusiness extends BasePublicDBBusiness
{
    ...
    // 注：历史表不要重置此属性
    public static $ignoreFields = ['paper_category_id'];
    // 获得记录历史id
    public static function getIdHistory($mainId = 0, &$mainDBObj = null, &$historyDBObj = null){
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::getHistoryId($mainDBObj, $mainId, CompanyPaperCategoryHistoryDBBusiness::$model_name
            , CompanyPaperCategoryHistoryDBBusiness::$table_name, $historyDBObj, ['paper_category_id' => $mainId], static::$ignoreFields);
    }
    ...
    public static function compareHistory($id = 0, $forceIncVersion = 0, &$mainDBObj = null, &$historyDBObj = null){
        ...
        $historySearch = [
            ...
            'paper_category_id' => $id,
        ];
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::compareHistoryOrUpdateVersion($mainDBObj, $id, CompanyPaperCategoryHistoryDBBusiness::$model_name
            , CompanyPaperCategoryHistoryDBBusiness::$table_name, $historyDBObj, $historySearch, static::$ignoreFields, $forceIncVersion);
    }
