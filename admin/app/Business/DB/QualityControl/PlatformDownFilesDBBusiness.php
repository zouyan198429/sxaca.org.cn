 ...
 *
 */
class PlatformDownFilesDBBusiness extends BasePublicDBBusiness
{
...
//                    $resourceArr = ['column_type' => 128, 'column_id' => $id];
//                    ResourceDBBusiness::saveByIds($resourceArr, $resourceIds);
//                }
                // ResourceDBBusiness::bathResourceSync(static::thisObj(), 128, [['id' => $id, 'resourceIds' => $resourceIds, 'otherData' => []]], $operate_staff_id, $operate_staff_id_history);
                ResourceDBBusiness::resourceSync(static::thisObj(), 128, $id, $resourceIds, [], $operate_staff_id, $operate_staff_id_history);
            }
    ...
    public static function delById($company_id, $id, $operate_staff_id = 0, $modifAddOprate = 0, $extendParams = []){
        ...
        CommonDB::doTransactionFun(function() use( &$id, &$organize_id){
            // 删除资源及文件
            ResourceDBBusiness::delResourceByIds(static::thisObj(), $id, 128);
