 ...
 *
 */
class CompanySubjectAnswerDBBusiness extends BasePublicDBBusiness
{
    ...
    // 注：历史表不要重置此属性
    public static $ignoreFields = ['answer_id'];
    ...
    public static function getIdHistory($mainId = 0, &$mainDBObj = null, &$historyDBObj = null){
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::getHistoryId($mainDBObj, $mainId, CompanySubjectAnswerHistoryDBBusiness::$model_name
            , CompanySubjectAnswerHistoryDBBusiness::$table_name, $historyDBObj, ['answer_id' => $mainId], static::$ignoreFields);
    }
    ...
    public static function compareHistory($id = 0, $forceIncVersion = 0, &$mainDBObj = null, &$historyDBObj = null){
        ...
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::compareHistoryOrUpdateVersion($mainDBObj, $id, CompanySubjectAnswerHistoryDBBusiness::$model_name
            , CompanySubjectAnswerHistoryDBBusiness::$table_name, $historyDBObj, $historySearch, static::$ignoreFields, $forceIncVersion);
    }
