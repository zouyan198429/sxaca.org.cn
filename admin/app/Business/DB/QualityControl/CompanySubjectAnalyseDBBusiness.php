 ...
 *
 */
class CompanySubjectAnalyseDBBusiness extends BasePublicDBBusiness
{
    ...
    // 注：历史表不要重置此属性
    public static $ignoreFields = ['subject_analyse_id'];
    // 获得记录历史id
    public static function getIdHistory($mainId = 0, &$mainDBObj = null, &$historyDBObj = null){
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::getHistoryId($mainDBObj, $mainId, CompanySubjectAnalyseHistoryDBBusiness::$model_name
            , CompanySubjectAnalyseHistoryDBBusiness::$table_name, $historyDBObj, ['subject_analyse_id' => $mainId], static::$ignoreFields);
    }
    ...
    public static function compareHistory($id = 0, $forceIncVersion = 0, &$mainDBObj = null, &$historyDBObj = null){
        ...
        $historySearch = [
            ...
            'subject_analyse_id' => $id,
        ];
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::compareHistoryOrUpdateVersion($mainDBObj, $id, CompanySubjectAnalyseHistoryDBBusiness::$model_name
            , CompanySubjectAnalyseHistoryDBBusiness::$table_name, $historyDBObj, $historySearch, static::$ignoreFields, $forceIncVersion);
    }
