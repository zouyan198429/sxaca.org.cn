 ...
 *
 */
class AbilityJoinItemsSamplesDBBusiness extends BasePublicDBBusiness
{
...
//        }
            ...
            // 能力验证取样登记样品结果
            if($has_sample_result){
                $sample_result_ids = AbilityJoinItemsSampleResultDBBusiness::updateByDataList(['sample_id' => $id], ['sample_id' => $id]
                    , $items_sample_result, $isModify, $operate_staff_id, $operate_staff_id_history
