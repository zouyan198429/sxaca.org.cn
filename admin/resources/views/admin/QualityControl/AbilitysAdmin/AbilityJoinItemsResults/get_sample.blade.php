...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/abilitys_admin/' . ($ability_id ?? 0)  . '/ability_join_items_results/ajax_save_sample') }}";// ajax保存取样地址
    var LIST_URL = "{{url('admin/abilitys_admin/' . ($ability_id ?? 0)  . '/ability_join_items_results')}}";//保存成功后跳转到的地址

</script>
<script src="{{ asset('/js/admin/QualityControl/AbilitysAdmin/AbilityJoinItemsResults_get_sample.js') }}?2"  type="text/javascript"></script>
</body>
</html>
