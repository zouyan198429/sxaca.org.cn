...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlVodTypeInfo";

    var SAVE_URL = "{{ url('api/admin/vod_type/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/vod_type')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/admin/QualityControl/VodType_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
