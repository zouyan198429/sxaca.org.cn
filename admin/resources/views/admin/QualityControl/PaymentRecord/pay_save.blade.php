...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/payment_record/ajax_create_order') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/payment_record')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/admin/QualityControl/VodOrders_pay_save.js') }}?72"  type="text/javascript"></script>
