...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlVodCommentInfo";
...
<script src="{{ asset('/js/admin/QualityControl/VodComment_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
