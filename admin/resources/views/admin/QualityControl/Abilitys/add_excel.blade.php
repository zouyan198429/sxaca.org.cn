...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlAbilitysedit";

    var SAVE_URL = "{{ url('api/admin/abilitys/ajax_excel_save') }}";// ajax保存记录地址
    ...
    var UPLOAD_LARGE_URL = "{{ url('api/admin/abilitys/up_excel') }}";//上传excel地址
...
<script src="{{ asset('/js/admin/QualityControl/Abilitys_excel.js') }}?9"  type="text/javascript"></script>
