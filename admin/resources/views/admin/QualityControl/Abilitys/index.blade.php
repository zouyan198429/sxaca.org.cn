...
<div class="mm">
  <div class="mmhead" id="mywork">
    ...
    <div class="table-header">
        <button class="btn  import_excel"  onclick="otheraction.upExcelFile(0)">导入结果</button>
...
{{--        <th></th>--}}
  ...
  <script type="text/javascript">
      ...
      var IFRAME_UPEXCEL_URL = "{{url('admin/abilitys/add_excel/')}}/";//添加/修改页面地址前缀 + id
      var IFRAME_UPEXCEL_URL_TITLE = "导入能力验证结果" ;// 详情弹窗显示提示  [添加/修改] +  栏目/主题

  </script>
  <script src="{{asset('js/common/list.js')}}?2"></script>
  <script src="{{ asset('js/admin/QualityControl/Abilitys.js') }}?826"  type="text/javascript"></script>
</body>
</html>
