...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/company_content/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/company_content')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/admin/QualityControl/CompanyContent_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
