...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlLiveNoticeInfo";
...
<script src="{{ asset('/js/admin/QualityControl/LiveNotice_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
