...
<div class="mm">
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            ...
            <tr>
                <th>试卷名称<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="company_paper_name" value="{{ $info['company_paper_name'] ?? '' }}" placeholder="请输入试卷名称"/>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/company_paper/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/company_paper')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/admin/QualityControl/CompanyPaper_edit.js') }}?1"  type="text/javascript"></script>
</body>
</html>
