...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/company_punish/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/company_punish')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业

    // 文件上传相关的~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // var UPLOAD_COMMON_URL = "{ { url('api/admin/upload') }}";// 文件上传提交地址 'your/file/upload/url'
    // var UPLOAD_WORD_URL = "{ { url('api/admin/company_punish/up_word') }}";//上传word地址
    var UPLOAD_LARGE_URL = "{{ url('api/admin/company_punish/up_file') }}";//上传excel地址
    // var UPLOAD_GRID_URL = "{ { url('api/admin/company_punish/up_pdf') }}";//上传pdf地址
...
<script src="{{ asset('/js/admin/QualityControl/CompanyPunish_edit.js') }}?13"  type="text/javascript"></script>
