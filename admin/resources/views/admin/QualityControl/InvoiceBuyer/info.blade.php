...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlInvoiceBuyerInfo";
...
<script src="{{ asset('/js/admin/QualityControl/InvoiceBuyer_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
