...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/laboratory_addr/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/laboratory_addr')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/admin/QualityControl/LaboratoryAddr_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
