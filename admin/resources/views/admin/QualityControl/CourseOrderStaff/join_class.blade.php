...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/course_order_staff/ajax_join_class_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/course_order_staff')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/admin/QualityControl/CourseOrderStaff_join_class.js') }}"  type="text/javascript"></script>
</body>
</html>
