    ...
    <div class="layui-layout layui-layout-admin">
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          ...
          <div class="layui-logo" lay-href="javascript:void(0);">
            <span>{{ $info['class_name'] ?? '' }}-班级管理</span>
          </div>
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            {{--</li>--}}
              ...
              <li data-name="user" class="layui-nav-item">
                  <a  lay-href="{{ url('admin/course_class_admin/' . ($class_id ?? 0)  . '/basic') }}" lay-tips="概况" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>概况</cite>
                  </a>
              </li>
              <li data-name="user" class="layui-nav-item">
                  <a  lay-href="{{ url('admin/course_class_company') }}?&hidden_option=2&course_id={{ $info['course_id'] ?? '' }}&class_id={{ $class_id ?? '' }}" lay-tips="班级企业" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>班级企业</cite>
                  </a>
              </li>
              <li data-name="user" class="layui-nav-item">
                  <a  lay-href="{{ url('admin/course_order_staff') }}?&hidden_option=2&course_id={{ $info['course_id'] ?? '' }}&class_id={{ $class_id ?? '' }}" lay-tips="学员管理" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>学员管理</cite>
                  </a>
              </li>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          ...
          <iframe src="{{ url('admin/course_class_admin/' . ($class_id ?? 0)  . '/basic') }}" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
