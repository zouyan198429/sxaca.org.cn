...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/market/certificate_schedule/company_modify') }}";// "{ { url('api/admin/API/certificate_schedule/ajax_bath_save') }}";// ajax保存记录地址
...
<script src="{{ asset('/js/admin/QualityControl/API/CertificateSchedule_company_modify.js') }}?6"  type="text/javascript"></script>
