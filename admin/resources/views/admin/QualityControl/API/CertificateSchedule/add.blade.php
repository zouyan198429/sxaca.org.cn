...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/API/certificate_schedule/ajax_save') }}";// ajax保存记录地址
...
<script src="{{ asset('/js/admin/QualityControl/API/CertificateSchedule_edit.js') }}?2"  type="text/javascript"></script>
</body>
</html>
