...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/company_ability/ajax_excel_save') }}";// ajax保存记录地址
    ...
    var UPLOAD_LARGE_URL = "{{ url('api/admin/company_ability/up_excel') }}";//上传excel地址
...
<script src="{{ asset('/js/admin/QualityControl/CompanyAbility_excel.js') }}?8"  type="text/javascript"></script>
