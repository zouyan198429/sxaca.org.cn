    ...
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="inp wnormal"  name="test_code" value="{{ $info['test_code'] ?? '' }}" placeholder="请输入检验检测机构代码"/>
                </td>
            </tr>
            <tr>
                <th>年<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="test_year" value="{{ $info['test_year'] ?? '' }}" placeholder="请输入年"  onkeyup="isnum(this) " onafterpaste="isnum(this)"  />
                </td>
            </tr>
            <tr>
                <th>检测项目<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="test_item" value="{{ $info['test_item'] ?? '' }}" placeholder="请输入检测项目"/>
                </td>
            </tr>
            <tr>
                <th>验证结果<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="test_result" value="{{ $info['test_result'] ?? '' }}" placeholder="请输入验证结果"/>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlCompanyAbilityedit";
...
<script src="{{ asset('/js/admin/QualityControl/CompanyAbility_edit.js') }}?7"  type="text/javascript"></script>
</body>
</html>
