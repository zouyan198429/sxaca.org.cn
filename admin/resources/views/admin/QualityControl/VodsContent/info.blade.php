...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlVodsContentInfo";
...
<script src="{{ asset('/js/admin/QualityControl/VodsContent_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
