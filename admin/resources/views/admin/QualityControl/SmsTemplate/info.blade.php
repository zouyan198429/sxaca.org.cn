...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlSmsTemplateInfo";
...
<script src="{{ asset('/js/admin/QualityControl/SmsTemplate_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
