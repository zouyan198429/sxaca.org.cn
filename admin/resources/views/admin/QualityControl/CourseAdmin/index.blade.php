    ...
    <div class="layui-layout layui-layout-admin">
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          ...
          <div class="layui-logo" lay-href="javascript:void(0);">
            <span>{{ $info['course_name'] ?? '' }}-课程管理</span>
          </div>
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
              ...
              <li data-name="user" class="layui-nav-item"  style="display: block;">
                  <a href="javascript:;" lay-tips="培训班管理" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>培训班管理</cite>
                  </a>
                  <dl class="layui-nav-child">
                      <dd>
                          <a lay-href="{{ url('admin/course_class') }}?&hidden_option=2&course_id={{ $course_id ?? '' }}">培训班【所有】</a>
                      </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_class') }}?&hidden_option=6&class_status=1&course_id={{ $course_id ?? '' }}">培训班【待开班】</a>
                        </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_class') }}?&hidden_option=6&class_status=2&course_id={{ $course_id ?? '' }}">培训班【开班中】</a>
                        </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_class') }}?&hidden_option=6&class_status=8&course_id={{ $course_id ?? '' }}">培训班【已结业】</a>
                        </dd>
                  </dl>
              </li>
              <li data-name="user" class="layui-nav-item"  style="display: block;">
                  <a href="javascript:;" lay-tips="报名企业管理" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>报名企业管理</cite>
                  </a>
                  <dl class="layui-nav-child">
                      <dd>
                          <a lay-href="{{ url('admin/course_order') }}?&hidden_option=2&course_id={{ $course_id ?? '' }}">报名企业【所有】</a>
                      </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_order') }}?&hidden_option=6&pay_status=1&course_id={{ $course_id ?? '' }}">报名企业【待缴费】</a>
                        </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_order') }}?&hidden_option=6&pay_status=4&course_id={{ $course_id ?? '' }}">报名企业【已缴费】</a>
                        </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_order') }}?&hidden_option=6&pay_status=16&course_id={{ $course_id ?? '' }}">报名企业【已退费】</a>
                        </dd>
                  </dl>
              </li>
              <li data-name="user" class="layui-nav-item"  style="display: block;">
                  <a href="javascript:;" lay-tips="报名学员" lay-direction="2">
                      <i class="layui-icon layui-icon-component"></i>
                      <cite>报名学员管理</cite>
                  </a>
                  <dl class="layui-nav-child">
                      <dd>
                          <a lay-href="{{ url('admin/course_order_staff') }}?&hidden_option=2&course_id={{ $course_id ?? '' }}">报名学员【所有】</a>
                      </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_order_staff') }}?&hidden_option=6&join_class_status=1&course_id={{ $course_id ?? '' }}">报名学员【待分班】</a>
                        </dd>
                        <dd>
                            <a lay-href="{{ url('admin/course_order_staff') }}?&hidden_option=6&join_class_status=4&course_id={{ $course_id ?? '' }}">报名学员【已分班】</a>
                        </dd>
                  </dl>
              </li>
          </ul>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          ...
          <iframe src="{{ url('admin/course_admin/' . ($course_id ?? 0)  . '/basic') }}" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
