...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlCompanyInspectInfo";
...
<script src="{{ asset('/js/admin/QualityControl/CompanyInspect_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
