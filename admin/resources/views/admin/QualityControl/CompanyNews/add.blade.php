    ...
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="inp wnormal"  name="new_title" value="{{ $info['new_title'] ?? '' }}" placeholder="请输入标题"/>
                </td>
            </tr>
            <tr>
                <th>内容<span class="must">*</span></th>
                <td>
                    <textarea class="kindeditor" name="new_content" rows="15" id="doc-ta-1" style=" width:770px;height:400px;">{!!  htmlspecialchars($info['new_content'] ?? '' )   !!}</textarea>
                </td>
            </tr>
            <tr>
                <th> </th>
...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlCompanyNewsedit";

    var SAVE_URL = "{{ url('api/admin/company_news/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/company_news')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/admin/QualityControl/CompanyNews_edit.js') }}?5"  type="text/javascript"></script>
</body>
</html>
