...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlPaymentProjectInfo";

    var SAVE_URL = "{{ url('api/admin/payment_project/ajax_pay_save') }}";// ajax保存记录地址
...
<script src="{{ asset('/js/admin/QualityControl/PaymentProject_add_pay.js') }}?19"  type="text/javascript"></script>
