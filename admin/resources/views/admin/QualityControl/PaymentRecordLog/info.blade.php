...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlPaymentRecordLogInfo";
...
<script src="{{ asset('/js/admin/QualityControl/PaymentRecordLog_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
