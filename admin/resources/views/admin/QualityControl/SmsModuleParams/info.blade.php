...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlSmsModuleParamsInfo";
...
<script src="{{ asset('/js/admin/QualityControl/SmsModuleParams_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
