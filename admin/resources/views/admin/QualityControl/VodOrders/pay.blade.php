...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/admin/vod_orders/ajax_join_class_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/vod_orders')}}";//保存成功后跳转到的地址

    var PAY_SAVE_URL = "{{url('admin/vod_orders/pay_save')}}";// 收款页面
</script>
<script src="{{ asset('/js/admin/QualityControl/VodOrders_pay.js') }}?11"  type="text/javascript"></script>
</body>
</html>
