...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "adminQualityControlSmsModuleParamsCommonInfo";
...
<script src="{{ asset('/js/admin/QualityControl/SmsModuleParamsCommon_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
