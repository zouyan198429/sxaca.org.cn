...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/user/payment_project/ajax_save') }}";// ajax保存记录地址
    ...
    var UPLOAD_LARGE_URL = "{{ url('api/user/payment_project/up_file') }}";//上传excel地址
    // var UPLOAD_GRID_URL = "{ { url('api/admin/vods/up_pdf') }}";//上传pdf地址

    var DOWN_FILE_URL = "{{ url('user/down_file') }}";// 下载网页打印机驱动
...
<script src="{{ asset('/js/user/QualityControl/PaymentProject_edit.js') }}?54"  type="text/javascript"></script>
