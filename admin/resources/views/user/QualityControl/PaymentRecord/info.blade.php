...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "userQualityControlPaymentRecordInfo";

    var SAVE_URL = "{{ url('api/user/payment_record/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('user/payment_record')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('user/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/user/QualityControl/PaymentRecord_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
