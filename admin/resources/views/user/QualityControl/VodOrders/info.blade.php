...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "userQualityControlVodOrdersInfo";

    var SAVE_URL = "{{ url('api/user/vod_orders/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('user/vod_orders')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/user/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/user/QualityControl/VodOrders_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
