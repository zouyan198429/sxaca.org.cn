...
<script type="text/javascript">
    // var SAVE_URL = "{{ url('api/expert/abilitys_admin/' . ($ability_id ?? 0)  . '/ability_join_items/ajax_save_result_sample') }}";// ajax保存提交数据地址
    var LIST_URL = "{{url('expert/abilitys_admin/' . ($ability_id ?? 0)  . '/ability_join_items')}}";//保存成功后跳转到的地址
    var DOWN_FILE_URL = "{{ url('expert/down_file') }}";// 下载网页打印机驱动
...
<script src="{{ asset('/js/expert/QualityControl/AbilitysAdmin/AbilityJoinItems_sample_result_info.js') }}?13"  type="text/javascript"></script>
