...
{{--                <div class="layui-form-mid layui-word-aux">可用于后台登入</div>--}}
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="real_name" value="{{ $real_name ?? '' }}"  class="layui-input">
                </div>
             ...
             --}}
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="tel" value="{{ $tel ?? '' }}"  autocomplete="off" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">QQ/邮箱/微信</label>
                <div class="layui-input-inline">
                  <input type="text" name="qq_number" value="{{ $qq_number ?? '' }}" lay-verify="email" autocomplete="off" class="layui-input">
                </div>
              </div>
              {{---
  ...
  --}}
  <script>
      const SAVE_URL = "{{ url('api/expert/ajax_info_save') }}";
      const SET_URL = "{{url('expert/info')}}";
  </script>
