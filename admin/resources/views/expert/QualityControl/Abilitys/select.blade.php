...
<div class="mm">
  ...
  <script type="text/javascript">
      ...
      var OPEN_OPERATE_URL = "{{ url('api/expert/abilitys/ajax_open') }}";//审核操作(通过/不通过)
      var ACCOUNT_STATUS_URL = "{{ url('api/expert/abilitys/ajax_frozen') }}";//操作(冻结/解冻)
  ...
  <script src="{{ asset('js/expert/QualityControl/Abilitys_select.js') }}"  type="text/javascript"></script>
</body>
</html>
