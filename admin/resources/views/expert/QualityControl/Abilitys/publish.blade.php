...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/expert/abilitys/ajax_save_publish') }}";// ajax保存记录地址
    var LIST_URL = "{{url('expert/abilitys')}}";//保存成功后跳转到的地址

    var PUBLISH_TIME = "{{ $info['publish_time'] ?? '' }}" ;//报名开始时间

</script>
<script src="{{ asset('/js/expert/QualityControl/Abilitys_publish.js') }}?5"  type="text/javascript"></script>
</body>
</html>
