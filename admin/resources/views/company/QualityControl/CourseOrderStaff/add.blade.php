...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/company/course_order_staff/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/course_order_staff')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/company/QualityControl/CourseOrderStaff_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
