...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "companyQualityControlVodsInfo";

    var SAVE_URL = "{{ url('api/company/vods/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/vods')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('company/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/company/QualityControl/Vods_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
