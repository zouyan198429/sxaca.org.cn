...
<script type="text/javascript">
    ...
    var SAVE_URL = "{{ url('api/company/vod_orders/ajax_create_order') }}";// ajax保存记录地址
    ...
    var AJAX_QUERY_ORDER_WX_URL = "{{ url('api/company/order_pay/ajax_wx_query_order') }}";// ajax查询微信扫码支付是否成功地址
...
<script src="{{ asset('/js/company/QualityControl/VodOrders_pay_save.js') }}?72"  type="text/javascript"></script>
