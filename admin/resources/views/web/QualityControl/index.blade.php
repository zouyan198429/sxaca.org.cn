        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="{{ url('web/info') }}">基本资料</a></dd>
              <dd><a lay-href="{{ url('web/password') }}">修改密码</a></dd>
              <hr>
              <dd  style="text-align: center;"><a href="{{ url('web/logout') }}">退出</a></dd>
            </dl>
          </li>
