...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "webQualityControlMarketCompanyNewsInfo";

    var SAVE_URL = "{{ url('api/web/market/company_news/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('web/market/company_news')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/company/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/web/QualityControl/Market/CompanyNews_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
