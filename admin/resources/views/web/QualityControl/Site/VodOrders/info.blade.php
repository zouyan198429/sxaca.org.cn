...
<script type="text/javascript">
    ...
    var PARENT_BUSINESS_FUN_NAME = "webQualityControlVodOrdersInfo";

    var SAVE_URL = "{{ url('api/web/vod_orders/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('web/vod_orders')}}";//保存成功后跳转到的地址

    var SELECT_COMPANY_URL = "{{url('admin/web/select')}}";// 选择所属企业
</script>
<script src="{{ asset('/js/web/QualityControl/Site/VodOrders_info.js') }}?2"  type="text/javascript"></script>
</body>
</html>
